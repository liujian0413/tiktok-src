...
public class CronetClient1 implements ICronetClient {
    ...
    public String getCronetVersion() {
        return "TTNetVersion:f052c1d9 2019-12-25";
    }
                                ...
                                if (metrics != null) {
                                    ...
                                    try {
                                        if (C48317f.m149883a().loggerDebug()) {
                                            ...
                                            C48317f.m149883a().loggerD("CronetClient1", sb3.toString());
                                            StringBuilder sb4 = new StringBuilder(" dns_cost = ");
                                            sb4.append(CronetClient1.this.getCostTime(getTime(metrics.getDnsEnd()), getTime(metrics.getDnsStart())));
                                            sb4.append(" ms ");
                                            String sb5 = sb4.toString();
                                            StringBuilder sb6 = new StringBuilder();
                                            sb6.append(sb5);
                                            sb6.append(" connect_cost = ");
                                            sb6.append(CronetClient1.this.getCostTime(getTime(metrics.getConnectEnd()), getTime(metrics.getConnectStart())));
                                            sb6.append(" ms ");
                                            String sb7 = sb6.toString();
                                            StringBuilder sb8 = new StringBuilder();
                                            sb8.append(sb7);
                                            sb8.append(" ssl_cost = ");
                                            sb8.append(CronetClient1.this.getCostTime(getTime(metrics.getSslEnd()), getTime(metrics.getSslStart())));
                                            sb8.append(" ms ");
                                            String sb9 = sb8.toString();
                                            StringBuilder sb10 = new StringBuilder();
                                            sb10.append(sb9);
                                            sb10.append(" sending_cost = ");
                                            sb10.append(CronetClient1.this.getCostTime(getTime(metrics.getSendingEnd()), getTime(metrics.getSendingStart())));
                                            sb10.append(" ms ");
                                            String sb11 = sb10.toString();
                                            StringBuilder sb12 = new StringBuilder();
                                            sb12.append(sb11);
                                            sb12.append(" push_cost = ");
                                            sb12.append(CronetClient1.this.getCostTime(getTime(metrics.getPushEnd()), getTime(metrics.getPushStart())));
                                            sb12.append(" ms ");
                                            String sb13 = sb12.toString();
                                            StringBuilder sb14 = new StringBuilder();
                                            sb14.append(sb13);
                                            sb14.append(" response_cost = ");
                                            sb14.append(CronetClient1.this.getCostTime(getTime(metrics.getRequestEnd()), getTime(metrics.getResponseStart())));
                                            sb14.append(" ms ");
    ...
    public static void triggerGetDomain(Context context) {
        try {
            if (C48320i.m149888a(context)) {
                if (C48317f.m149883a().loggerDebug()) {
                    C48317f.m149883a().loggerD("CronetClient1", "triggerGetDomain start");
                }
                if (sCronetEngine instanceof ExperimentalCronetEngine) {
    ...
    public static void syncHttpEncryptConfig(Map<String, Object> map) {
            ...
            try {
                if (!map.isEmpty()) {
                    if (C48317f.m149883a().loggerDebug()) {
                        ...
                        C48317f.m149883a().loggerD("CronetClient1", sb.toString());
                    }
                    ...
                    if (bArr != null) {
                        if (bArr.length > 0) {
                            if (bArr2 != null) {
                                if (bArr2.length > 0) {
                                    if (TextUtils.isEmpty(str2)) {
                                        if (C48317f.m149883a().loggerDebug()) {
                                            C48317f.m149883a().loggerD("CronetClient1", "syncHttpEncryptConfig token is null");
                                        }
                                        return;
                                    } else if (longValue <= 0) {
                                        if (C48317f.m149883a().loggerDebug()) {
                                            C48317f.m149883a().loggerD("CronetClient1", "syncHttpEncryptConfig expire <= 0");
                                        }
                                        return;
                                    } else {
                                        ...
                                        if (sCronetEngine instanceof ExperimentalCronetEngine) {
                                            if (C48317f.m149883a().loggerDebug()) {
                                                ...
                                                C48317f.m149883a().loggerD("CronetClient1", sb2.toString());
                                            }
                            ...
                            if (C48317f.m149883a().loggerDebug()) {
                                C48317f.m149883a().loggerD("CronetClient1", "syncHttpEncryptConfig hmac_key is null");
                            }
                            return;
                        }
                    }
                    if (C48317f.m149883a().loggerDebug()) {
                        C48317f.m149883a().loggerD("CronetClient1", "syncHttpEncryptConfig key is null");
                    }
                    return;
                }
            } catch (Throwable unused) {
        ...
        if (C48317f.m149883a().loggerDebug()) {
            C48317f.m149883a().loggerD("CronetClient1", "syncHttpEncryptConfig json is null");
        }
    }
    ...
    public java.lang.String getConfigFromAssets(android.content.Context r4, java.lang.String r5) {
        ...
        L_0x0032:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.chromium.CronetClient1.getConfigFromAssets(android.content.Context, java.lang.String):java.lang.String");
    }
        ...
        try {
            if (C48320i.m149888a(context)) {
                if (TextUtils.isEmpty(str)) {
                    if (C48317f.m149883a().loggerDebug()) {
                        C48317f.m149883a().loggerD("CronetClient1", "doCommand json is null");
                    }
                    return;
                }
                if (C48317f.m149883a().loggerDebug()) {
    ...
    /* JADX WARNING: Missing exception handler attribute for start block: B:65:0x0137 */
    /* JADX WARNING: Missing exception handler attribute for start block: B:72:0x0171 */
    /* JADX WARNING: Removed duplicated region for block: B:68:0x0143 A[SYNTHETIC, Splitter:B:68:0x0143] */
    ...
    private void tryCreateCronetEngine(android.content.Context r6, boolean r7, boolean r8, boolean r9, boolean r10, java.lang.String r11, java.util.concurrent.Executor r12) {
        /*
            r5 = this;
            com.ttnet.org.chromium.net1.CronetEngine r0 = sCronetEngine
            if (r0 != 0) goto L_0x01d5
            java.lang.Class<org.chromium.CronetClient> r0 = org.chromium.CronetClient.class
            monitor-enter(r0)
            com.ttnet.org.chromium.net1.CronetEngine r1 = sCronetEngine     // Catch:{ all -> 0x01d2 }
            if (r1 != 0) goto L_0x01be
            com.bytedance.frameworks.baselib.network.http.cronet.ICronetClient$ICronetBootFailureChecker r1 = sCronetBootFailureChecker     // Catch:{ all -> 0x01d2 }
            if (r1 == 0) goto L_0x01be
            com.bytedance.frameworks.baselib.network.http.cronet.ICronetClient$ICronetBootFailureChecker r1 = sCronetBootFailureChecker     // Catch:{ all -> 0x01d2 }
            boolean r1 = r1.isCronetBootFailureExpected()     // Catch:{ all -> 0x01d2 }
            if (r1 == 0) goto L_0x01be
            com.ttnet.org.chromium.net1.ExperimentalCronetEngine$Builder r1 = new com.ttnet.org.chromium.net1.ExperimentalCronetEngine$Builder     // Catch:{ all -> 0x01d2 }
            r1.<init>(r6)     // Catch:{ all -> 0x01d2 }
            com.ttnet.org.chromium.net1.ExperimentalCronetEngine$Builder r7 = r1.enableQuic(r7)     // Catch:{ all -> 0x01d2 }
            com.ttnet.org.chromium.net1.ExperimentalCronetEngine$Builder r7 = r7.enableHttp2(r8)     // Catch:{ all -> 0x01d2 }
            com.ttnet.org.chromium.net1.ExperimentalCronetEngine$Builder r7 = r7.enableSdch(r9)     // Catch:{ all -> 0x01d2 }
            com.ttnet.org.chromium.net1.ExperimentalCronetEngine$Builder r7 = r7.enableHttpDns(r10)     // Catch:{ all -> 0x01d2 }
            r8 = 0
            r10 = 0
            com.ttnet.org.chromium.net1.ExperimentalCronetEngine$Builder r7 = r7.enableHttpCache(r10, r8)     // Catch:{ all -> 0x01d2 }
            r1 = 1
            com.ttnet.org.chromium.net1.ExperimentalCronetEngine$Builder r7 = r7.enableNetworkQualityEstimator(r1)     // Catch:{ all -> 0x01d2 }
            org.chromium.f r2 = org.chromium.C48317f.m149883a()     // Catch:{ all -> 0x01d2 }
            boolean r2 = r2.loggerDebug()     // Catch:{ all -> 0x01d2 }
            if (r2 == 0) goto L_0x0045
            r7.enableVerboseLog()     // Catch:{ all -> 0x01d2 }
        L_0x0045:
            org.chromium.b r2 = org.chromium.C48313b.m149832a(r6)     // Catch:{ all -> 0x01d2 }
            r7.setAppInfoProvider(r2)     // Catch:{ all -> 0x01d2 }
            org.chromium.h r2 = org.chromium.C48319h.m149885a()     // Catch:{ all -> 0x01d2 }
            r7.setEventListener(r2)     // Catch:{ all -> 0x01d2 }
            boolean r2 = org.chromium.C48320i.m149888a(r6)     // Catch:{ all -> 0x01d2 }
            if (r2 == 0) goto L_0x0066
            org.chromium.d r2 = org.chromium.C48315d.m149834a()     // Catch:{ all -> 0x01d2 }
            r7.setAppMonitorProvider(r2)     // Catch:{ all -> 0x01d2 }
            org.chromium.h r2 = org.chromium.C48319h.m149885a()     // Catch:{ all -> 0x01d2 }
            r2.f123374a = r1     // Catch:{ all -> 0x01d2 }
        L_0x0066:
            boolean r2 = android.text.TextUtils.isEmpty(r11)     // Catch:{ all -> 0x01d2 }
            if (r2 != 0) goto L_0x0080
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ all -> 0x01d2 }
            r2.<init>()     // Catch:{ all -> 0x01d2 }
            r2.append(r11)     // Catch:{ all -> 0x01d2 }
            java.lang.String r11 = " cronet/TTNetVersion:f052c1d9 2019-12-25"
            r2.append(r11)     // Catch:{ all -> 0x01d2 }
            java.lang.String r11 = r2.toString()     // Catch:{ all -> 0x01d2 }
            r7.setUserAgent(r11)     // Catch:{ all -> 0x01d2 }
        L_0x0080:
            org.chromium.e r11 = org.chromium.C48316e.m149835a()     // Catch:{ all -> 0x01d2 }
            java.lang.String r11 = r11.mo121724L()     // Catch:{ all -> 0x01d2 }
            if (r11 == 0) goto L_0x008d
            r7.setGetDomainDefaultJSON(r11)     // Catch:{ all -> 0x01d2 }
        L_0x008d:
        ...
        L_0x00b9:
            ...
            java.lang.String r11 = r5.getConfigFromAssets(r6, r11)     // Catch:{ all -> 0x01d2 }
            boolean r3 = android.text.TextUtils.isEmpty(r11)     // Catch:{ all -> 0x01d2 }
        ...
        L_0x00e9:
            ...
            java.io.File r11 = r6.getFilesDir()     // Catch:{ all -> 0x01d2 }
            java.lang.String r11 = r11.getAbsolutePath()     // Catch:{ all -> 0x01d2 }
            boolean r3 = android.text.TextUtils.isEmpty(r11)     // Catch:{ all -> 0x01d2 }
        ...
        L_0x0119:
            ...
            org.chromium.e r10 = org.chromium.C48316e.m149835a()     // Catch:{ all -> 0x01d2 }
            java.lang.String r10 = r10.mo121725M()     // Catch:{ all -> 0x01d2 }
            boolean r11 = android.text.TextUtils.isEmpty(r10)     // Catch:{ all -> 0x01d2 }
            if (r11 != 0) goto L_0x012c
            r7.setBypassBOEJSON(r10)     // Catch:{ all -> 0x01d2 }
        L_0x012c:
            long r10 = getALogFuncAddr()     // Catch:{ Exception -> 0x0137 }
            int r3 = (r10 > r8 ? 1 : (r10 == r8 ? 0 : -1))
            if (r3 == 0) goto L_0x0137
            r7.setALogFuncAddr(r10)     // Catch:{ Exception -> 0x0137 }
        L_0x0137:
            com.ttnet.org.chromium.net1.ExperimentalCronetEngine r7 = r7.build()     // Catch:{ all -> 0x01d2 }
            sCronetEngine = r7     // Catch:{ all -> 0x01d2 }
            boolean r7 = android.text.TextUtils.isEmpty(r2)     // Catch:{ all -> 0x01d2 }
            if (r7 != 0) goto L_0x0171
            java.io.File r7 = new java.io.File     // Catch:{ Throwable -> 0x0171 }
            java.lang.StringBuilder r8 = new java.lang.StringBuilder     // Catch:{ Throwable -> 0x0171 }
            r8.<init>()     // Catch:{ Throwable -> 0x0171 }
            r8.append(r2)     // Catch:{ Throwable -> 0x0171 }
            java.lang.String r6 = org.chromium.C48320i.m149889b(r6)     // Catch:{ Throwable -> 0x0171 }
            r8.append(r6)     // Catch:{ Throwable -> 0x0171 }
            java.lang.String r6 = "_netlog.json"
            r8.append(r6)     // Catch:{ Throwable -> 0x0171 }
            java.lang.String r6 = r8.toString()     // Catch:{ Throwable -> 0x0171 }
            r7.<init>(r6)     // Catch:{ Throwable -> 0x0171 }
            boolean r6 = r7.exists()     // Catch:{ Throwable -> 0x0171 }
            if (r6 == 0) goto L_0x0171
            com.ttnet.org.chromium.net1.CronetEngine r6 = sCronetEngine     // Catch:{ Throwable -> 0x0171 }
            com.ttnet.org.chromium.net1.ExperimentalCronetEngine r6 = (com.ttnet.org.chromium.net1.ExperimentalCronetEngine) r6     // Catch:{ Throwable -> 0x0171 }
            java.lang.String r7 = r7.getAbsolutePath()     // Catch:{ Throwable -> 0x0171 }
            r6.startNetLogToFile(r7, r1)     // Catch:{ Throwable -> 0x0171 }
        L_0x0171:
            org.chromium.f r6 = org.chromium.C48317f.m149883a()     // Catch:{ all -> 0x01d2 }
            boolean r6 = r6.loggerDebug()     // Catch:{ all -> 0x01d2 }
            if (r6 == 0) goto L_0x0180
            r6 = 2
            com.ttnet.org.chromium.base.Logger.setLogLevel(r6)     // Catch:{ all -> 0x01d2 }
            goto L_0x0184
        L_0x0180:
            r6 = 4
            com.ttnet.org.chromium.base.Logger.setLogLevel(r6)     // Catch:{ all -> 0x01d2 }
        L_0x0184:
            com.ttnet.org.chromium.net1.CronetEngine r6 = sCronetEngine     // Catch:{ all -> 0x01d2 }
            boolean r6 = r6 instanceof com.ttnet.org.chromium.net1.ExperimentalCronetEngine     // Catch:{ all -> 0x01d2 }
            if (r6 == 0) goto L_0x01be
            com.ttnet.org.chromium.net1.CronetEngine r6 = sCronetEngine     // Catch:{ all -> 0x01d2 }
            com.ttnet.org.chromium.net1.ExperimentalCronetEngine r6 = (com.ttnet.org.chromium.net1.ExperimentalCronetEngine) r6     // Catch:{ all -> 0x01d2 }
            java.lang.String r7 = sTokenStr     // Catch:{ all -> 0x01d2 }
            boolean r7 = android.text.TextUtils.isEmpty(r7)     // Catch:{ all -> 0x01d2 }
            if (r7 != 0) goto L_0x01be
            org.chromium.f r7 = org.chromium.C48317f.m149883a()     // Catch:{ all -> 0x01d2 }
            boolean r7 = r7.loggerDebug()     // Catch:{ all -> 0x01d2 }
            if (r7 == 0) goto L_0x01b9
            org.chromium.f r7 = org.chromium.C48317f.m149883a()     // Catch:{ all -> 0x01d2 }
            java.lang.String r8 = "CronetClient1"
            java.lang.StringBuilder r9 = new java.lang.StringBuilder     // Catch:{ all -> 0x01d2 }
            java.lang.String r10 = "createCronetEngine send token = "
            r9.<init>(r10)     // Catch:{ all -> 0x01d2 }
            java.lang.String r10 = sTokenStr     // Catch:{ all -> 0x01d2 }
            r9.append(r10)     // Catch:{ all -> 0x01d2 }
            java.lang.String r9 = r9.toString()     // Catch:{ all -> 0x01d2 }
            r7.loggerD(r8, r9)     // Catch:{ all -> 0x01d2 }
        L_0x01b9:
            java.lang.String r7 = sTokenStr     // Catch:{ all -> 0x01d2 }
            r6.setToken(r7)     // Catch:{ all -> 0x01d2 }
        L_0x01be:
            com.ttnet.org.chromium.net1.CronetEngine r6 = sCronetEngine     // Catch:{ all -> 0x01d2 }
            boolean r6 = r6 instanceof com.ttnet.org.chromium.net1.ExperimentalCronetEngine     // Catch:{ all -> 0x01d2 }
            ...
            com.ttnet.org.chromium.net1.CronetEngine r6 = sCronetEngine     // Catch:{ all -> 0x01d2 }
            com.ttnet.org.chromium.net1.ExperimentalCronetEngine r6 = (com.ttnet.org.chromium.net1.ExperimentalCronetEngine) r6     // Catch:{ all -> 0x01d2 }
            r5.tryCreateRequestFinishedInfoListener(r12)     // Catch:{ all -> 0x01d2 }
            com.ttnet.org.chromium.net1.RequestFinishedInfo$Listener r7 = sRequestFinishedInfoListener     // Catch:{ all -> 0x01d2 }
            r6.addRequestFinishedListener(r7)     // Catch:{ all -> 0x01d2 }
        L_0x01d0:
        ...
        L_0x01d5:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.chromium.CronetClient1.tryCreateCronetEngine(android.content.Context, boolean, boolean, boolean, boolean, java.lang.String, java.util.concurrent.Executor):void");
    }
}
