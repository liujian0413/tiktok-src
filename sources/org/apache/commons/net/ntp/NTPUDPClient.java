...
public final class NTPUDPClient extends DatagramSocketClient {
    ...
    public final TimeInfo getTime(InetAddress inetAddress) throws IOException {
        return getTime(inetAddress, 123);
    }

    public final TimeInfo getTime(InetAddress inetAddress, int i) throws IOException {
        if (!isOpen()) {
            open();
        }
