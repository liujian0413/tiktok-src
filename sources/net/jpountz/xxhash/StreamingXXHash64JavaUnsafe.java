...
final class StreamingXXHash64JavaUnsafe extends AbstractStreamingXXHash64Java {
    ...
    public final void update(byte[] bArr, int i, int i2) {
        ...
        if (this.memSize > 0) {
            ...
            this.f123145v1 += UnsafeUtils.readLongLE(this.memory, 0) * -4417276706812531889L;
            this.f123145v1 = Long.rotateLeft(this.f123145v1, 31);
            this.f123145v1 *= -7046029288634856825L;
            this.f123146v2 += UnsafeUtils.readLongLE(this.memory, 8) * -4417276706812531889L;
            this.f123146v2 = Long.rotateLeft(this.f123146v2, 31);
            this.f123146v2 *= -7046029288634856825L;
            this.f123147v3 += UnsafeUtils.readLongLE(this.memory, 16) * -4417276706812531889L;
            this.f123147v3 = Long.rotateLeft(this.f123147v3, 31);
            this.f123147v3 *= -7046029288634856825L;
            this.f123148v4 += UnsafeUtils.readLongLE(this.memory, 24) * -4417276706812531889L;
        ...
        while (i3 <= i6) {
            j = Long.rotateLeft(j + (UnsafeUtils.readLongLE(bArr2, i3) * -4417276706812531889L), 31) * -7046029288634856825L;
            int i7 = i3 + 8;
            j2 = Long.rotateLeft(j2 + (UnsafeUtils.readLongLE(bArr2, i7) * -4417276706812531889L), 31) * -7046029288634856825L;
            int i8 = i7 + 8;
            j3 = Long.rotateLeft(j3 + (UnsafeUtils.readLongLE(bArr2, i8) * -4417276706812531889L), 31) * -7046029288634856825L;
            int i9 = i8 + 8;
            j4 = Long.rotateLeft(j4 + (UnsafeUtils.readLongLE(bArr2, i9) * -4417276706812531889L), 31) * -7046029288634856825L;
            i3 = i9 + 8;
        }
        this.f123145v1 = j;
        this.f123146v2 = j2;
