...
final class XXHash64JavaSafe extends XXHash64 {
    ...
    public final long hash(byte[] bArr, int i, int i2, long j) {
        ...
        if (i4 >= 32) {
            ...
            i3 = i;
            while (true) {
                rotateLeft = Long.rotateLeft(j5 + (SafeUtils.readLongLE(bArr2, i3) * j4), 31) * -7046029288634856825L;
                int i6 = i3 + 8;
                rotateLeft2 = Long.rotateLeft(j6 + (SafeUtils.readLongLE(bArr2, i6) * j4), 31) * -7046029288634856825L;
                int i7 = i6 + 8;
                rotateLeft3 = Long.rotateLeft(j7 + (SafeUtils.readLongLE(bArr2, i7) * j4), 31) * -7046029288634856825L;
                int i8 = i7 + 8;
                j8 = Long.rotateLeft(j8 + (SafeUtils.readLongLE(bArr2, i8) * -4417276706812531889L), 31) * -7046029288634856825L;
                i3 = i8 + 8;
                if (i3 > i5 - 32) {
                    break;
                }
        ...
        while (i3 <= i5 - 8) {
            i3 += 8;
            j9 = (Long.rotateLeft(j9 ^ (Long.rotateLeft(SafeUtils.readLongLE(bArr2, i3) * -4417276706812531889L, 31) * -7046029288634856825L), 27) * -7046029288634856825L) - 8796714831421723037L;
        }
        if (i3 <= i5 - 4) {
            j3 = (Long.rotateLeft(j9 ^ ((((long) SafeUtils.readIntLE(bArr2, i3)) & 4294967295L) * -7046029288634856825L), 23) * -4417276706812531889L) + 1609587929392839161L;
            i3 += 4;
        } else {
            j3 = j9;
        }
        while (i3 < i5) {
            j3 = Long.rotateLeft(j3 ^ (((long) (SafeUtils.readByte(bArr2, i3) & 255)) * 2870177450012600261L), 11) * -7046029288634856825L;
            i3++;
        }
