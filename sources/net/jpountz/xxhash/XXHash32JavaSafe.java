...
final class XXHash32JavaSafe extends XXHash32 {
    ...
    public final int hash(byte[] bArr, int i, int i2, int i3) {
        ...
        if (i2 >= 16) {
            ...
            int i9 = i3 - -1640531535;
            do {
                i6 = Integer.rotateLeft(i6 + (SafeUtils.readIntLE(bArr, i) * -2048144777), 13) * -1640531535;
                int i10 = i + 4;
        ...
        int i13 = i4 + i2;
        while (i <= i5 - 4) {
            i13 = Integer.rotateLeft(i13 + (SafeUtils.readIntLE(bArr, i) * -1028477379), 17) * 668265263;
            i += 4;
        }
        while (i < i5) {
            i13 = Integer.rotateLeft(i13 + ((SafeUtils.readByte(bArr, i) & 255) * 374761393), 11) * -1640531535;
            i++;
        }
        int i14 = ((i13 >>> 15) ^ i13) * -2048144777;
        int i15 = (i14 ^ (i14 >>> 13)) * -1028477379;
