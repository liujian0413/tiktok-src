...
final class LZ4JavaUnsafeSafeDecompressor extends LZ4SafeDecompressor {
    ...
    public final int decompress(byte[] bArr, int i, int i2, byte[] bArr2, int i3, int i4) {
        ...
        if (i4 != 0) {
            ...
            int i14 = i10;
            while (true) {
                byte readByte = UnsafeUtils.readByte(bArr3, i13) & 255;
                i5 = i13 + 1;
                i6 = readByte >>> 4;
                if (i6 == 15) {
                    int i15 = -1;
                ...
                LZ4UnsafeUtils.wildArraycopy(bArr3, i5, bArr4, i14, i6);
                int readShortLE = UnsafeUtils.readShortLE(bArr3, i20);
                int i21 = i20 + 2;
                ...
                if (i22 >= i10) {
                    ...
                    if (i23 == 15) {
                        ...
                        while (true) {
                            ...
                            int i25 = i21 + 1;
                            i8 = UnsafeUtils.readByte(bArr3, i21);
                            if (i8 != -1) {
                                i21 = i25;
                                break;
                            }
                    ...
                    int i27 = i7 + i26;
                    if (i27 <= i19) {
                        LZ4UnsafeUtils.wildIncrementalCopy(bArr4, i22, i7, i27);
                    } else if (i27 <= i12) {
                        LZ4UnsafeUtils.safeIncrementalCopy(bArr4, i22, i7, i26);
                    } else {
            ...
            if (i7 > i12) {
                ...
                LZ4UnsafeUtils.safeArraycopy(bArr3, i5, bArr4, i14, i6);
                return i7 - i10;
            } else {
        ...
        } else if (i9 == 1 && UnsafeUtils.readByte(bArr, i) == 0) {
            return 0;
        } else {
