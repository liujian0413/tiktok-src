...
final class LZ4JavaSafeCompressor extends LZ4Compressor {
    ...
    static int compress64k(java.nio.ByteBuffer r18, int r19, int r20, java.nio.ByteBuffer r21, int r22, int r23) {
        ...
        L_0x0022:
            ...
            int r15 = net.jpountz.util.SafeUtils.readShort(r2, r14)
            int r15 = r15 + r1
            r16 = r11
            int r11 = r8 - r1
        ...
        L_0x00a7:
            ...
            int r11 = net.jpountz.util.SafeUtils.readShort(r2, r9)
            int r15 = r1 + r11
            int r11 = r8 - r1
    ...
    public final int compress(java.nio.ByteBuffer r20, int r21, int r22, java.nio.ByteBuffer r23, int r24, int r25) {
        ...
        L_0x0070:
            ...
            r16 = r12
            int r12 = net.jpountz.util.SafeUtils.readInt(r7, r15)
            r17 = r13
            int r13 = r6 - r12
        ...
        L_0x00f9:
            ...
            int r12 = net.jpountz.util.SafeUtils.readInt(r7, r1)
            net.jpountz.util.SafeUtils.writeInt(r7, r1, r6)
            int r13 = r6 - r12
     ...
     */
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x005b, code lost:
        net.jpountz.util.SafeUtils.writeByte(r3, r10, 240);
     ...
     */
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x00cc, code lost:
        if (net.jpountz.lz4.LZ4SafeUtils.readIntEquals(r0, r8, r15) == false) goto L_0x00d5;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x00ce, code lost:
        r12 = r10 + 1;
    ...
    static int compress64k(byte[] r18, int r19, int r20, byte[] r21, int r22, int r23) {
        ...
        L_0x0022:
            ...
            int r11 = r11 >>> r14
            if (r12 > r7) goto L_0x00f4
            int r14 = net.jpountz.util.SafeUtils.readInt(r0, r8)
            int r14 = net.jpountz.lz4.LZ4Utils.hash64k(r14)
            int r15 = net.jpountz.util.SafeUtils.readShort(r2, r14)
            int r15 = r15 + r1
            r16 = r11
            ...
            if (r11 < r13) goto L_0x0067
            r14 = 240(0xf0, float:3.36E-43)
            net.jpountz.util.SafeUtils.writeByte(r3, r10, r14)
            int r14 = r11 + -15
            int r12 = net.jpountz.lz4.LZ4SafeUtils.writeLen(r14, r3, r12)
            goto L_0x006c
        L_0x0067:
            int r14 = r11 << 4
            net.jpountz.util.SafeUtils.writeByte(r3, r10, r14)
        ...
        L_0x0070:
            ...
            int r8 = r8 + 4
            int r15 = r15 + 4
            int r9 = net.jpountz.lz4.LZ4SafeUtils.commonBytes(r0, r15, r8, r6)
            int r11 = r12 + 6
            int r14 = r9 >>> 8
            int r11 = r11 + r14
            if (r11 > r5) goto L_0x00de
            int r8 = r8 + r9
            if (r9 < r13) goto L_0x009a
            byte r11 = net.jpountz.util.SafeUtils.readByte(r3, r10)
            r11 = r11 | r13
            net.jpountz.util.SafeUtils.writeByte(r3, r10, r11)
            int r9 = r9 + -15
            int r9 = net.jpountz.lz4.LZ4SafeUtils.writeLen(r9, r3, r12)
            r10 = r9
            goto L_0x00a3
        L_0x009a:
            byte r11 = net.jpountz.util.SafeUtils.readByte(r3, r10)
        ...
        L_0x00a7:
            int r9 = r8 + -2
            int r11 = net.jpountz.util.SafeUtils.readInt(r0, r9)
            int r11 = net.jpountz.lz4.LZ4Utils.hash64k(r11)
            int r9 = r9 - r1
            net.jpountz.util.SafeUtils.writeShort(r2, r11, r9)
            int r9 = net.jpountz.util.SafeUtils.readInt(r0, r8)
            int r9 = net.jpountz.lz4.LZ4Utils.hash64k(r9)
            int r11 = net.jpountz.util.SafeUtils.readShort(r2, r9)
            int r15 = r1 + r11
            int r11 = r8 - r1
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:30:0x00e9, code lost:
        if (net.jpountz.lz4.LZ4SafeUtils.readIntEquals(r0, r11, r7) == false) goto L_0x00f2;
     */
    ...
    public final int compress(byte[] r19, int r20, int r21, byte[] r22, int r23, int r24) {
        /*
            ...
            r2 = r21
            r3 = r22
            net.jpountz.util.SafeUtils.checkRange(r19, r20, r21)
            net.jpountz.util.SafeUtils.checkRange(r22, r23, r24)
            int r5 = r23 + r24
        ...
        L_0x003a:
            ...
            int r14 = net.jpountz.util.SafeUtils.readInt(r0, r7)
            int r14 = net.jpountz.lz4.LZ4Utils.hash(r14)
            r15 = r11
            int r11 = net.jpountz.util.SafeUtils.readInt(r8, r14)
            r16 = r12
            int r12 = r7 - r11
            net.jpountz.util.SafeUtils.writeInt(r8, r14, r7)
            r14 = 65536(0x10000, float:9.18355E-41)
            if (r12 >= r14) goto L_0x010a
            boolean r17 = net.jpountz.lz4.LZ4SafeUtils.readIntEquals(r0, r11, r7)
            if (r17 == 0) goto L_0x010a
            int r13 = net.jpountz.lz4.LZ4SafeUtils.commonBytesBackward(r0, r11, r7, r1, r9)
            int r7 = r7 - r13
            int r11 = r11 - r13
            int r13 = r7 - r9
            int r14 = r10 + 1
            ...
            int r1 = r13 + -15
            int r14 = net.jpountz.lz4.LZ4SafeUtils.writeLen(r1, r3, r14)
            goto L_0x0089
        L_0x0084:
            int r1 = r13 << 4
            net.jpountz.util.SafeUtils.writeByte(r3, r10, r1)
        ...
        L_0x008d:
            ...
            int r7 = r7 + 4
            int r11 = r11 + 4
            int r1 = net.jpountz.lz4.LZ4SafeUtils.commonBytes(r0, r11, r7, r4)
            int r9 = r14 + 6
            int r11 = r1 >>> 8
            int r9 = r9 + r11
            ...
            net.jpountz.util.SafeUtils.writeByte(r3, r10, r11)
            int r1 = r1 + -15
            int r1 = net.jpountz.lz4.LZ4SafeUtils.writeLen(r1, r3, r14)
            r10 = r1
            goto L_0x00bf
        L_0x00b6:
            byte r11 = net.jpountz.util.SafeUtils.readByte(r3, r10)
        ...
        L_0x00c3:
            int r1 = r7 + -2
            int r11 = net.jpountz.util.SafeUtils.readInt(r0, r1)
            int r11 = net.jpountz.lz4.LZ4Utils.hash(r11)
            net.jpountz.util.SafeUtils.writeInt(r8, r11, r1)
            int r1 = net.jpountz.util.SafeUtils.readInt(r0, r7)
            int r1 = net.jpountz.lz4.LZ4Utils.hash(r1)
            int r11 = net.jpountz.util.SafeUtils.readInt(r8, r1)
            net.jpountz.util.SafeUtils.writeInt(r8, r1, r7)
            int r12 = r7 - r11
            r1 = 65536(0x10000, float:9.18355E-41)
            if (r12 >= r1) goto L_0x00f2
            boolean r13 = net.jpountz.lz4.LZ4SafeUtils.readIntEquals(r0, r11, r7)
