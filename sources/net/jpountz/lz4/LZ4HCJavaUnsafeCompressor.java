...
final class LZ4HCJavaUnsafeCompressor extends LZ4Compressor {
    ...
    class HashTable {
        ...
        static {
            Class<LZ4HCJavaUnsafeCompressor> cls = LZ4HCJavaUnsafeCompressor.class;
        }
        ...
        public boolean insertAndFindBestMatch(ByteBuffer byteBuffer, int i, int i2, Match match) {
            ...
            int i5 = hashPointer;
            for (int i6 = 0; i6 < LZ4HCJavaUnsafeCompressor.this.maxAttempts && i5 >= Math.max(this.base, (i - 65536) + 1) && i5 <= i; i6++) {
        ...
        public boolean insertAndFindBestMatch(byte[] bArr, int i, int i2, Match match) {
            ...
            int i5 = hashPointer;
            for (int i6 = 0; i6 < LZ4HCJavaUnsafeCompressor.this.maxAttempts && i5 >= Math.max(this.base, (i - 65536) + 1) && i5 <= i; i6++) {
                if (LZ4UnsafeUtils.readIntEquals(bArr, i5, i)) {
                    int commonBytes = LZ4UnsafeUtils.commonBytes(bArr, i5 + 4, i + 4, i2) + 4;
                    if (commonBytes > match.len) {
                        match.ref = i5;
                        match.len = commonBytes;
                    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:68:0x0226, code lost:
        r11 = r9;
        r0 = net.jpountz.lz4.LZ4UnsafeUtils.encodeSequence(r24, r0, r14.start, r14.ref, r14.len, r27, r15, r10);
        r3 = r14.end();
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final int compress(byte[] r24, int r25, int r26, byte[] r27, int r28, int r29) {
        /*
            r23 = this;
            r0 = r25
            net.jpountz.util.UnsafeUtils.checkRange(r24, r25, r26)
            net.jpountz.util.UnsafeUtils.checkRange(r27, r28, r29)
            int r1 = r0 + r26
            int r10 = r28 + r29
            int r11 = r1 + -12
            int r12 = r1 + -5
        ...
        L_0x0134:
            ...
            r12 = r9
            r9 = r10
            int r15 = net.jpountz.lz4.LZ4UnsafeUtils.encodeSequence(r2, r3, r4, r5, r6, r7, r8, r9)
            int r2 = r14.end()
            net.jpountz.lz4.LZ4Utils.copyTo(r0, r14)
        ...
        L_0x01fa:
            ...
            int r5 = r12.ref
            int r6 = r12.len
            int r0 = net.jpountz.lz4.LZ4UnsafeUtils.encodeSequence(r2, r3, r4, r5, r6, r7, r8, r9)
            int r3 = r12.end()
            goto L_0x023c
        L_0x021e:
            r16 = r6
