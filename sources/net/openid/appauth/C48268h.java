...
final class C48268h {
    /* renamed from: a */
    static InputStream m149756a(HttpURLConnection httpURLConnection) throws IOException {
    ...
    /* renamed from: a */
    static void m149757a(HttpURLConnection httpURLConnection, String str, String str2) {
        URLConnection uRLConnection = httpURLConnection;
        if (C7118e.m22232a(uRLConnection)) {
