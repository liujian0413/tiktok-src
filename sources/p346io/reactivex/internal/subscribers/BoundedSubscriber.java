...
public final class BoundedSubscriber<T> extends AtomicReference<C48294d> implements C7321c, C47597i<T>, C48294d {
    ...
    public final void onNext(T t) {
        if (!isDisposed()) {
            try {
                ...
                if (i == this.limit) {
                    this.consumed = 0;
                    ((C48294d) get()).request((long) this.limit);
                } else {
                    this.consumed = i;
                }
            } catch (Throwable th) {
    ...
    public BoundedSubscriber(C7326g<? super T> gVar, C7326g<? super Throwable> gVar2, C7323a aVar, C7326g<? super C48294d> gVar3, int i) {
        this.onNext = gVar;
        this.onError = gVar2;
