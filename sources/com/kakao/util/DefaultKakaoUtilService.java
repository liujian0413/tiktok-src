...
class DefaultKakaoUtilService implements KakaoUtilService {
    ...
    public IConfiguration getAppConfiguration(Context context) {
        ...
        return Factory.createConfiguration(context);
    }
    ...
    private boolean validateTalkAuthenticity(Context context, String str, int i) {
        try {
            ...
            if (!validateTalkMinVersion(packageInfo, i) || !validateTalkPackagName(str) || !validateTalkSignature(packageInfo)) {
                return false;
            }
            return true;
    ...
    public Intent resolveIntent(Context context, Intent intent, int i) {
        ...
        Intent createChooser = Intent.createChooser((Intent) arrayList2.remove(0), context.getString(R.string.a7e));
