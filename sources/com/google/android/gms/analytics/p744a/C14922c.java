...
public final class C14922c {
    ...
    /* renamed from: a */
    private Map<String, String> f38592a = new HashMap();

    /* renamed from: a */
    public final Map<String, String> mo37980a(String str) {
        HashMap hashMap = new HashMap();
        for (Entry entry : this.f38592a.entrySet()) {
    ...
    public final String toString() {
        return C14931j.m43372a((Map) this.f38592a);
    }
}
