...
abstract class bau {
    ...
    /* renamed from: a */
    public abstract int mo40459a(int i, byte[] bArr, int i2, int i3);

    /* access modifiers changed from: 0000 */
    /* renamed from: a */
    public abstract int mo40460a(CharSequence charSequence, byte[] bArr, int i, int i2);

    /* access modifiers changed from: 0000 */
    /* renamed from: a */
    public abstract void mo40461a(CharSequence charSequence, ByteBuffer byteBuffer);

    /* access modifiers changed from: 0000 */
    /* renamed from: b */
    public abstract String mo40463b(byte[] bArr, int i, int i2) throws zzcdx;

    /* access modifiers changed from: 0000 */
    /* renamed from: a */
    public final boolean mo40462a(byte[] bArr, int i, int i2) {
        return mo40459a(0, bArr, i, i2) == 0;
    }

    /* renamed from: b */
    static void m48249b(CharSequence charSequence, ByteBuffer byteBuffer) {
        int i;
