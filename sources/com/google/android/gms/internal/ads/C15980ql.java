...
final class C15980ql {
    /* renamed from: a */
    static InputStream m51967a(HttpURLConnection httpURLConnection) throws IOException {
    ...
    /* renamed from: a */
    static void m51968a(HttpURLConnection httpURLConnection, String str, String str2) {
        URLConnection uRLConnection = httpURLConnection;
        if (C7118e.m22232a(uRLConnection)) {
