...
final class C16419bl {
    /* renamed from: a */
    static InputStream m53509a(HttpURLConnection httpURLConnection) throws IOException {
    ...
    /* renamed from: a */
    static void m53510a(HttpURLConnection httpURLConnection, String str, String str2) {
        URLConnection uRLConnection = httpURLConnection;
        if (C7118e.m22232a(uRLConnection)) {
    ...
    /* renamed from: b */
    static void m53511b(HttpURLConnection httpURLConnection, String str, String str2) {
        URLConnection uRLConnection = httpURLConnection;
        if (C7118e.m22232a(uRLConnection)) {
            C7116a.m22226a(uRLConnection.getURL(), str, str2, "");
        } else if (C7163a.m22363a()) {
