...
public final class C16685kv {
    /* renamed from: a */
    public static <T extends C16684ku> String m54813a(T t) {
        StringBuffer stringBuffer = new StringBuffer();
        try {
            m54815a(null, t, new StringBuffer(), stringBuffer);
    ...
    /* renamed from: a */
    private static void m54815a(String str, Object obj, StringBuffer stringBuffer, StringBuffer stringBuffer2) throws IllegalAccessException, InvocationTargetException {
        Field[] fields;
        int i;
        if (obj != null) {
            if (obj instanceof C16684ku) {
                int length = stringBuffer.length();
                if (str != null) {
                    stringBuffer2.append(stringBuffer);
                    stringBuffer2.append(m54814a(str));
                ...
                for (Field field : cls.getFields()) {
                    ...
                    if (!"cachedSize".equals(name) && (modifiers & 1) == 1 && (modifiers & 8) != 8 && !name.startsWith("_") && !name.endsWith("_")) {
                        ...
                        if (!type.isArray() || type.getComponentType() == Byte.TYPE) {
                            m54815a(name, obj2, stringBuffer, stringBuffer2);
                        } else {
                            if (obj2 == null) {
                                i = 0;
                            } else {
                            ...
                            for (int i2 = 0; i2 < i; i2++) {
                                m54815a(name, Array.get(obj2, i2), stringBuffer, stringBuffer2);
                            }
                        }
                    }
                }
                    ...
                    if (name3.startsWith("set")) {
                        ...
                        try {
                            ...
                            if (((Boolean) cls.getMethod(valueOf.length() != 0 ? str2.concat(valueOf) : new String(str2), new Class[0]).invoke(obj, new Object[0])).booleanValue()) {
                                ...
                                m54815a(substring, cls.getMethod(valueOf2.length() != 0 ? str3.concat(valueOf2) : new String(str3), new Class[0]).invoke(obj, new Object[0]), stringBuffer, stringBuffer2);
                            }
    ...
    /* renamed from: a */
    private static String m54814a(String str) {
        StringBuffer stringBuffer = new StringBuffer();
