...
/* renamed from: com.vk.sdk.api.httpClient.b */
final class C47142b {
    /* renamed from: a */
    static void m147389a(HttpURLConnection httpURLConnection, String str, String str2) {
    ...
    /* renamed from: b */
    static void m147390b(HttpURLConnection httpURLConnection, String str, String str2) {
        URLConnection uRLConnection = httpURLConnection;
        if (C7118e.m22232a(uRLConnection)) {
            C7116a.m22226a(uRLConnection.getURL(), str, str2, "");
        } else if (C7163a.m22363a()) {
