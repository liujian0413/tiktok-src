...
final class DistinguishedNameParser {
    ...
    /* renamed from: dn */
    private final String f50645dn;
    private int end;
    private final int length = this.f50645dn.length();
    private int pos;
    ...
    public DistinguishedNameParser(X500Principal x500Principal) {
        this.f50645dn = x500Principal.getName("RFC2253");
    }
    ...
    public final String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f50645dn.toCharArray();
