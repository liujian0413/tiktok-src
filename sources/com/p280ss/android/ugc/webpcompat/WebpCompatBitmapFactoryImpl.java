...
/* renamed from: com.ss.android.ugc.webpcompat.WebpCompatBitmapFactoryImpl */
public class WebpCompatBitmapFactoryImpl implements C13294b {
    ...
    public static Bitmap hookDecodeFileDescriptor(FileDescriptor fileDescriptor, Rect rect, Options options) {
        Bitmap bitmap;
        C13838d.m40862a();
        if (nativeSeek(fileDescriptor, 0, false) != -1) {
