...
/* renamed from: com.ss.android.ugc.aweme.im.sdk.chat.viewholder.EPlatformSendViewHolder */
public class EPlatformSendViewHolder extends EPlatformReceiveViewHolder {

    /* renamed from: n */
    private C31050o f81228n;
    ...
    public final void mo81420a() {
        ...
        this.f81228n = new C31050o(this.f81195c);
    }
    ...
    /* renamed from: a */
    public final void mo81421a(Message message, Message message2, EPlatformCardContent ePlatformCardContent, int i) {
        this.f81226m = false;
        super.mo81421a(message, message2, ePlatformCardContent, i);
        this.f81228n.mo81521a(this.f81201i);
    }
}
