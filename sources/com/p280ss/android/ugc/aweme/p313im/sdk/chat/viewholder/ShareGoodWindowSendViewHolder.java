...
/* renamed from: com.ss.android.ugc.aweme.im.sdk.chat.viewholder.ShareGoodWindowSendViewHolder */
public class ShareGoodWindowSendViewHolder extends ShareGoodWindowViewHolder {

    /* renamed from: m */
    private C31050o f81339m;
    ...
    public final void mo81420a() {
        ...
        this.f81339m = new C31050o(this.f81195c);
    }
    ...
    public final void mo81421a(Message message, Message message2, BaseContent baseContent, int i) {
        ...
        this.f81339m.mo81521a(this.f81201i);
    }
}
