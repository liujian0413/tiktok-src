...
/* renamed from: com.ss.android.ugc.aweme.im.sdk.chat.viewholder.ShareChallengeSimpleSendViewHolder */
public class ShareChallengeSimpleSendViewHolder extends ShareChallengeSimpleViewHolder {

    /* renamed from: m */
    private C31050o f81314m;
    ...
    public final void mo81420a() {
        ...
        this.f81314m = new C31050o(this.f81195c);
    }
    ...
    public ShareChallengeSimpleSendViewHolder(View view, int i) {
        super(view, i);
    }
    ...
    public final void mo81421a(Message message, Message message2, ShareChallengeContent shareChallengeContent, int i) {
        ...
        this.f81314m.mo81521a(this.f81201i);
    }
}
