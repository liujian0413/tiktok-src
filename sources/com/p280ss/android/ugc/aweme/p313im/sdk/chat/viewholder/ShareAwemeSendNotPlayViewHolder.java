...
/* renamed from: com.ss.android.ugc.aweme.im.sdk.chat.viewholder.ShareAwemeSendNotPlayViewHolder */
public class ShareAwemeSendNotPlayViewHolder extends ShareAwemeReceiveNotPlayViewHolder {

    /* renamed from: m */
    private C31050o f81311m;
    ...
    public final void mo81420a() {
        ...
        this.f81311m = new C31050o(this.f81195c);
    }
    ...
    public ShareAwemeSendNotPlayViewHolder(View view, int i) {
        super(view, i);
    }
    ...
    public final void mo81421a(Message message, Message message2, ShareAwemeContent shareAwemeContent, int i) {
        ...
        this.f81311m.mo81521a(this.f81201i);
    }
}
