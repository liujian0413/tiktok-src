...
/* renamed from: com.ss.android.ugc.aweme.im.sdk.chat.viewholder.TextSendViewHolder */
public class TextSendViewHolder extends TextViewHolder {

    /* renamed from: m */
    private C31050o f81417m;
    ...
    public final void mo81420a() {
        ...
        this.f81417m = new C31050o(this.f81195c);
    }
    ...
    /* renamed from: a */
    public final void mo81421a(Message message, Message message2, TextContent textContent, int i) {
        super.mo81421a(message, message2, textContent, i);
        this.f81417m.mo81521a(this.f81201i);
    }
}
