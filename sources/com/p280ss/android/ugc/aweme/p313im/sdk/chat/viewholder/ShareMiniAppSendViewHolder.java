...
/* renamed from: com.ss.android.ugc.aweme.im.sdk.chat.viewholder.ShareMiniAppSendViewHolder */
public class ShareMiniAppSendViewHolder extends ShareMiniAppViewHolder {

    /* renamed from: m */
    private C31050o f81349m;
    ...
    public final void mo81420a() {
        ...
        this.f81349m = new C31050o(this.f81195c);
    }
    ...
    public final void mo81421a(Message message, Message message2, BaseContent baseContent, int i) {
        ...
        this.f81349m.mo81521a(this.f81201i);
    }
}
