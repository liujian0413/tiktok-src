...
/* renamed from: com.ss.android.ugc.aweme.im.sdk.chat.viewholder.SharePoiSendViewHolder */
public class SharePoiSendViewHolder extends SharePoiViewHolder {

    /* renamed from: m */
    private C31050o f81362m;
    ...
    public final void mo81420a() {
        ...
        this.f81362m = new C31050o(this.f81195c);
    }
    ...
    /* renamed from: a */
    public final void mo81421a(Message message, Message message2, SharePoiContent sharePoiContent, int i) {
        super.mo81421a(message, message2, sharePoiContent, i);
        this.f81362m.mo81521a(this.f81201i);
    }
}
