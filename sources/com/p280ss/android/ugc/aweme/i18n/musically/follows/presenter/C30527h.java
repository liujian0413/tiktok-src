...
/* renamed from: com.ss.android.ugc.aweme.i18n.musically.follows.presenter.h */
final class C30527h extends C30521c {
    C30527h(String str) {
        super(str);
    }
    ...
    public final C30520b mo80229a(String str, long j, int i, int i2) throws Exception {
        return FollowFollowerApi.m99658b(str, j, i, i2);
    }
}
