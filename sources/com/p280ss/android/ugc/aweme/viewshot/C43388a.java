...
/* renamed from: com.ss.android.ugc.aweme.viewshot.a */
public final class C43388a {

    /* renamed from: a */
    public static final Matrix f112376a = new Matrix();

    /* renamed from: a */
    public static String m137687a(Activity activity) {
        View findViewById = activity.findViewById(16908290);
        if (findViewById != null) {
            return m137689a(findViewById);
        }
    ...
    /* renamed from: a */
    private static String m137689a(View view) {
        boolean z;
        String str;
        String str2;
        ...
        while (!stack.empty()) {
            ...
            sb4.append(m137688a(resources, view2));
    ...
    /* renamed from: b */
    private static String m137690b(Resources resources, View view) {
        if (resources == null) {
            return "";
        }
        try {
    ...
    /* renamed from: a */
    public static int m137686a(String str, String str2) {
        int i;
        int i2 = 0;
        while (str2.length() > 0) {
    ...
    /* renamed from: a */
    private static String m137688a(Resources resources, View view) {
        StringBuilder sb = new StringBuilder();
        sb.append(" id=");
        sb.append(view.getId());
        sb.append(m137690b(resources, view));
        ...
        if (!view.getMatrix().equals(f112376a)) {
            sb.append(", matrix=");
