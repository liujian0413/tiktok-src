...
public final class C23682i {

    /* renamed from: a */
    public static final C23682i f62437a = new C23682i();

    private C23682i() {
    }

    /* renamed from: a */
    public static final <T> void m77629a(List<T> list, List<? extends T> list2, C7563m<? super T, ? super T, Boolean> mVar) {
        Object obj;
