...
final class C42783c {
    /* renamed from: a */
    static InputStream m135797a(HttpURLConnection httpURLConnection) throws IOException {
    ...
    /* renamed from: a */
    static void m135798a(HttpURLConnection httpURLConnection, String str, String str2) {
        URLConnection uRLConnection = httpURLConnection;
        if (C7118e.m22232a(uRLConnection)) {
    ...
    /* renamed from: a */
    static boolean m135799a(Context context) {
        try {
