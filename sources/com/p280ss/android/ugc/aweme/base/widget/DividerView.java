...
public class DividerView extends View implements C23357b<DividerViewModel> {
    ...
    static /* synthetic */ class C235021 {

        /* renamed from: a */
        static final /* synthetic */ int[] f62006a = new int[Orientation.values().length];
        ...
        static {
            /*
                com.ss.android.ugc.aweme.base.widget.divider.DividerViewModel$Orientation[] r0 = com.p280ss.android.ugc.aweme.base.widget.divider.DividerViewModel.Orientation.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                f62006a = r0
                int[] r0 = f62006a     // Catch:{ NoSuchFieldError -> 0x0014 }
                com.ss.android.ugc.aweme.base.widget.divider.DividerViewModel$Orientation r1 = com.p280ss.android.ugc.aweme.base.widget.divider.DividerViewModel.Orientation.VERTICAL     // Catch:{ NoSuchFieldError -> 0x0014 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0014 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0014 }
            L_0x0014:
                int[] r0 = f62006a     // Catch:{ NoSuchFieldError -> 0x001f }
                com.ss.android.ugc.aweme.base.widget.divider.DividerViewModel$Orientation r1 = com.p280ss.android.ugc.aweme.base.widget.divider.DividerViewModel.Orientation.HORIZONTAL     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.p280ss.android.ugc.aweme.base.widget.DividerView.C235021.<clinit>():void");
        }
    }
    ...
    private void setColor(DividerViewModel dividerViewModel) {
        this.mForegroundColor = dividerViewModel.f62032e;
        this.mBackgroundColor = dividerViewModel.f62033f;
    }
    ...
    public void bind(DividerViewModel dividerViewModel) {
        ...
        int i = dividerViewModel.f62030c;
        if (i <= 0) {
            hide();
        }
        if (getVisibility() != 0) {
        ...
        int[] iArr = dividerViewModel.f62031d;
        if (iArr != null) {
        ...
        if (getLayoutParams() == null) {
            setLayoutParams(createLayoutParams(dividerViewModel.f62029a, i, dividerViewModel.f62034g));
            return;
        }
        LayoutParams layoutParams = getLayoutParams();
        if (C235021.f62006a[dividerViewModel.f62034g.ordinal()] != 2) {
    ...
    private android.view.ViewGroup.LayoutParams createLayoutParams(java.lang.Class<android.view.ViewGroup.LayoutParams> r6, int r7, com.p280ss.android.ugc.aweme.base.widget.divider.DividerViewModel.Orientation r8) {
        /*
            r5 = this;
        ...
        L_0x0024:
            int[] r6 = com.p280ss.android.ugc.aweme.base.widget.DividerView.C235021.f62006a     // Catch:{ Exception -> 0x0059 }
        ...
        L_0x0059:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p280ss.android.ugc.aweme.base.widget.DividerView.createLayoutParams(java.lang.Class, int, com.ss.android.ugc.aweme.base.widget.divider.DividerViewModel$Orientation):android.view.ViewGroup$LayoutParams");
    }
}
