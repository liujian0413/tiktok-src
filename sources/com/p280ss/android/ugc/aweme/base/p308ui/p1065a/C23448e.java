...
/* renamed from: com.ss.android.ugc.aweme.base.ui.a.e */
public final class C23448e extends C23443b {

    /* renamed from: a */
    public ViewGroup f61867a;

    /* renamed from: b */
    public final Activity f61868b;

    /* renamed from: l */
    public final String f61869l;

    /* renamed from: m */
    private JSONObject f61870m;
    ...
    private final java.lang.String m76958e() {
        /*
            r2 = this;
            org.json.JSONObject r0 = r2.f61870m
        ...
        L_0x000e:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p280ss.android.ugc.aweme.base.p308ui.p1065a.C23448e.m76958e():java.lang.String");
    }
    ...
    public final void mo59065a() {
        /*
            ...
            java.lang.String r3 = r4.f61869l
            com.ss.android.ugc.aweme.app.g.d r1 = r1.mo59973a(r2, r3)
            java.lang.String r2 = "log_pb"
            java.lang.String r3 = r4.m76958e()
            com.ss.android.ugc.aweme.app.g.d r1 = r1.mo59973a(r2, r3)
            java.lang.String r2 = "group_id"
            com.ss.android.ugc.aweme.feed.model.Aweme r3 = r4.f61858j
        ...
        L_0x0058:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p280ss.android.ugc.aweme.base.p308ui.p1065a.C23448e.mo59065a():void");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void mo59066a(android.view.View r4) {
        /*
            r3 = this;
            ...
            com.ss.android.ugc.aweme.feed.model.Aweme r1 = r3.f61858j
        ...
        L_0x001b:
            ...
            java.lang.String r1 = r3.f61869l
        ...
        L_0x00f3:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p280ss.android.ugc.aweme.base.p308ui.p1065a.C23448e.mo59066a(android.view.View):void");
    }
    ...
    public final void mo59067a(Aweme aweme, JSONObject jSONObject) {
        ...
        this.f61870m = jSONObject;
        this.f61851c.setImageResource(R.drawable.a2e);
        this.f61854f.setVisibility(0);
        this.f61853e.setVisibility(0);
        DmtTextView dmtTextView = this.f61854f;
        Context context = this.f61867a.getContext();
        C7573i.m23582a((Object) context, "parent.context");
        dmtTextView.setTextColor(context.getResources().getColor(R.color.l8));
        this.f61854f.setTextSize(13.0f);
        DmtTextView dmtTextView2 = this.f61854f;
        if (aweme != null) {
            ...
            if (anchor != null) {
                ...
                if (anchorInfo != null) {
                    ...
                    DmtTextView dmtTextView3 = this.f61852d;
                    Context context2 = this.f61867a.getContext();
                    C7573i.m23582a((Object) context2, "parent.context");
                    dmtTextView3.setText(context2.getResources().getString(R.string.e58));
                }
            }
        }
        str = null;
        dmtTextView2.setText(str);
        DmtTextView dmtTextView32 = this.f61852d;
        Context context22 = this.f61867a.getContext();
        C7573i.m23582a((Object) context22, "parent.context");
        dmtTextView32.setText(context22.getResources().getString(R.string.e58));
    }

    public C23448e(ViewGroup viewGroup, Activity activity, String str) {
        C7573i.m23587b(viewGroup, "parent");
        C7573i.m23587b(activity, "activity");
        C7573i.m23587b(str, "eventType");
        super(viewGroup);
        this.f61867a = viewGroup;
        this.f61868b = activity;
        this.f61869l = str;
    }
}
