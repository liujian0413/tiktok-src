...
/* renamed from: com.ss.android.ugc.aweme.base.arch.JediBaseFragment */
public abstract class JediBaseFragment extends AmeBaseFragment implements C11497af<C23274b>, C11592h {

    /* renamed from: e */
    public C23274b f61295e = new C23274b();

    /* renamed from: f */
    private HashMap f61296f;

    /* renamed from: a */
    public View mo60553a(int i) {
        if (this.f61296f == null) {
            this.f61296f = new HashMap();
        }
        View view = (View) this.f61296f.get(Integer.valueOf(i));
        if (view == null) {
            View view2 = getView();
            if (view2 == null) {
                return null;
            ...
            this.f61296f.put(Integer.valueOf(i), view);
        }
        return view;
    }
