...
/* renamed from: com.ss.android.ugc.aweme.commercialize.profile.BrandTabAdapter */
public final class BrandTabAdapter extends C1262a<HomeView> {

    /* renamed from: a */
    public CrossPlatformWebView f66044a;

    /* renamed from: b */
    private final Activity f66045b;

    /* renamed from: c */
    private String f66046c = null;

    /* renamed from: d */
    private boolean f66047d;

    /* renamed from: com.ss.android.ugc.aweme.commercialize.profile.BrandTabAdapter$HomeView */
    ...
    /* renamed from: a */
    public final void mo65508a(String str) {
    ...
    public HomeView onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        CrossPlatformWebView crossPlatformWebView = new CrossPlatformWebView(this.f66045b, null, 0, 6, null);
        this.f66044a = crossPlatformWebView;
        CrossPlatformWebView crossPlatformWebView2 = this.f66044a;
    ...
    public void onBindViewHolder(com.p280ss.android.ugc.aweme.commercialize.profile.BrandTabAdapter.HomeView r9, int r10) {
        /*
            r8 = this;
        ...
        L_0x0031:
            r10 = 0
        L_0x0032:
            android.app.Activity r1 = r8.f66045b
            ...
            int r1 = r1 - r2
            android.app.Activity r2 = r8.f66045b
            ...
            int r1 = r1 - r10
            boolean r10 = r8.f66047d
            if (r10 == 0) goto L_0x0069
            android.app.Activity r10 = r8.f66045b
        ...
        L_0x00a2:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p280ss.android.ugc.aweme.commercialize.profile.BrandTabAdapter.onBindViewHolder(com.ss.android.ugc.aweme.commercialize.profile.BrandTabAdapter$HomeView, int):void");
    }

    public BrandTabAdapter(Activity activity, String str, boolean z) {
        C7573i.m23587b(activity, "context");
        this.f66045b = activity;
        this.f66047d = z;
    }
}
