...
/* renamed from: com.ss.android.ugc.aweme.notification.newstyle.delegate.b */
public final class C34524b extends C34526c {

    /* renamed from: com.ss.android.ugc.aweme.notification.newstyle.delegate.b$a */
    public static final class C34525a implements C34527d {
        C34525a() {
        }
        ...
        public final String mo87836a() {
            String string = C6399b.m19921a().getString(R.string.cp3);
            C7573i.m23582a((Object) string, "AppContextManager.getApp…fication_group_assistant)");
            return string;
        }
        ...
        public final C1293v mo87835a(ViewGroup viewGroup, int i) {
            ...
            return new MusAssistantDetailHolder(inflate);
        }
        ...
        public final void mo87838a(C1293v vVar, BaseNotice baseNotice, int i, HashMap<String, BaseNotice> hashMap, boolean z) {
            ...
            if (vVar instanceof MusAssistantDetailHolder) {
                ((MusAssistantDetailHolder) vVar).mo87831a(baseNotice, z);
            }
        }
    }
