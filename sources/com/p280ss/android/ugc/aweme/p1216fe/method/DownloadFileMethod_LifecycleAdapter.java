...
public class DownloadFileMethod_LifecycleAdapter implements C0036d {

    /* renamed from: a */
    final DownloadFileMethod f73468a;

    DownloadFileMethod_LifecycleAdapter(DownloadFileMethod downloadFileMethod) {
        this.f73468a = downloadFileMethod;
    }
