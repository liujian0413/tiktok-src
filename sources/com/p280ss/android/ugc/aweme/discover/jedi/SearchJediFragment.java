...
/* renamed from: com.ss.android.ugc.aweme.discover.jedi.SearchJediFragment */
public abstract class SearchJediFragment<D> extends SearchFragment<D> implements C11497af<C23274b>, C11592h {

    /* renamed from: e */
    public C23274b f70385e = new C23274b();

    /* renamed from: f */
    private HashMap f70386f;

    /* renamed from: a */
    public View mo68429a(int i) {
        if (this.f70386f == null) {
            this.f70386f = new HashMap();
        }
        View view = (View) this.f70386f.get(Integer.valueOf(i));
        if (view == null) {
            View view2 = getView();
            if (view2 == null) {
                return null;
            ...
            this.f70386f.put(Integer.valueOf(i), view);
        }
        return view;
    }
