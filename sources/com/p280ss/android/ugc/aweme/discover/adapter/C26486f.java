...
final /* synthetic */ class C26486f implements C24939aj {

    /* renamed from: a */
    private final HotSearchItem f69861a;

    C26486f(HotSearchItem hotSearchItem) {
        this.f69861a = hotSearchItem;
    }

    /* renamed from: a */
    public final void mo63403a(String str, String str2, long j) {
        C24958f.m81906a(str, str2, j).mo65276b("track_url").mo65266a("track_ad").mo65285g("click").mo65261a(this.f69861a.getAdData()).mo65278b();
    }
}
