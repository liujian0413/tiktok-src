...
/* renamed from: com.ss.android.ugc.aweme.net.cache.f */
final class C34050f {
    /* renamed from: a */
    static C12534t m109636a(IesCacheInterceptpr iesCacheInterceptpr, C12470a aVar) throws Exception {
        if (!(aVar.mo30458b() instanceof C15459b)) {
            return IesCacheInterceptpr.m109628b(aVar);
        }
        ...
        bVar.mo39011a(iesCacheInterceptpr.getClass().getSimpleName());
        bVar.f39780t = SystemClock.uptimeMillis();
        C12534t b = IesCacheInterceptpr.m109628b(aVar);
        if (bVar.f39781u > 0) {
            long uptimeMillis2 = SystemClock.uptimeMillis() - bVar.f39781u;
            String simpleName = iesCacheInterceptpr.getClass().getSimpleName();
