...
final class C34045a {
    /* renamed from: a */
    static C12534t m109630a(CacheControlInterceptor cacheControlInterceptor, C12470a aVar) throws Exception {
        if (!(aVar.mo30458b() instanceof C15459b)) {
            return CacheControlInterceptor.m109626b(aVar);
        }
        ...
        bVar.mo39011a(cacheControlInterceptor.getClass().getSimpleName());
        bVar.f39780t = SystemClock.uptimeMillis();
        C12534t b = CacheControlInterceptor.m109626b(aVar);
        if (bVar.f39781u > 0) {
            long uptimeMillis2 = SystemClock.uptimeMillis() - bVar.f39781u;
            String simpleName = cacheControlInterceptor.getClass().getSimpleName();
