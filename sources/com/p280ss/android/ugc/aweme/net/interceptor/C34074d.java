...
/* renamed from: com.ss.android.ugc.aweme.net.interceptor.d */
final class C34074d {
    /* renamed from: a */
    static C12534t m109744a(ApiOkInterceptorTTNet apiOkInterceptorTTNet, C12470a aVar) throws Exception {
        if (!(aVar.mo30458b() instanceof C15459b)) {
            return ApiOkInterceptorTTNet.m109717b(aVar);
        }
        ...
        bVar.mo39011a(apiOkInterceptorTTNet.getClass().getSimpleName());
        bVar.f39780t = SystemClock.uptimeMillis();
        C12534t b = ApiOkInterceptorTTNet.m109717b(aVar);
        if (bVar.f39781u > 0) {
            long uptimeMillis2 = SystemClock.uptimeMillis() - bVar.f39781u;
            String simpleName = apiOkInterceptorTTNet.getClass().getSimpleName();
