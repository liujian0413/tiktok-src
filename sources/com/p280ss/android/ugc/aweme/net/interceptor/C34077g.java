...
final class C34077g {
    /* renamed from: a */
    static C12534t m109745a(CommonParamsInterceptorTTNet commonParamsInterceptorTTNet, C12470a aVar) throws Exception {
        if (!(aVar.mo30458b() instanceof C15459b)) {
            return CommonParamsInterceptorTTNet.m109719b(aVar);
        }
        ...
        bVar.mo39011a(commonParamsInterceptorTTNet.getClass().getSimpleName());
        bVar.f39780t = SystemClock.uptimeMillis();
        C12534t b = CommonParamsInterceptorTTNet.m109719b(aVar);
        if (bVar.f39781u > 0) {
            long uptimeMillis2 = SystemClock.uptimeMillis() - bVar.f39781u;
            String simpleName = commonParamsInterceptorTTNet.getClass().getSimpleName();
