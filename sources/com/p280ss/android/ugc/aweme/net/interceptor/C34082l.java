...
/* renamed from: com.ss.android.ugc.aweme.net.interceptor.l */
final class C34082l {
    /* renamed from: a */
    static C12534t m109748a(LinkSelectorInterceptorTTNet linkSelectorInterceptorTTNet, C12470a aVar) throws Exception {
        if (!(aVar.mo30458b() instanceof C15459b)) {
            return LinkSelectorInterceptorTTNet.m109729b(aVar);
        }
        ...
        bVar.mo39011a(linkSelectorInterceptorTTNet.getClass().getSimpleName());
        bVar.f39780t = SystemClock.uptimeMillis();
        C12534t b = LinkSelectorInterceptorTTNet.m109729b(aVar);
        if (bVar.f39781u > 0) {
            long uptimeMillis2 = SystemClock.uptimeMillis() - bVar.f39781u;
            String simpleName = linkSelectorInterceptorTTNet.getClass().getSimpleName();
