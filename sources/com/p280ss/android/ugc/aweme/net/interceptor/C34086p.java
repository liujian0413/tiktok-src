...
/* renamed from: com.ss.android.ugc.aweme.net.interceptor.p */
final class C34086p {
    /* renamed from: a */
    static C12534t m109750a(TTNetInitInterceptor tTNetInitInterceptor, C12470a aVar) throws Exception {
        if (!(aVar.mo30458b() instanceof C15459b)) {
            return TTNetInitInterceptor.m109733b(aVar);
        }
        ...
        bVar.mo39011a(tTNetInitInterceptor.getClass().getSimpleName());
        bVar.f39780t = SystemClock.uptimeMillis();
        C12534t b = TTNetInitInterceptor.m109733b(aVar);
        if (bVar.f39781u > 0) {
            long uptimeMillis2 = SystemClock.uptimeMillis() - bVar.f39781u;
            String simpleName = tTNetInitInterceptor.getClass().getSimpleName();
