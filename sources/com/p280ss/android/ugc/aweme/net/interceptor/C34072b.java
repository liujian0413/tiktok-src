...
final class C34072b {
    /* renamed from: a */
    static C12534t m109743a(ApiCheckInterceptorTTNet apiCheckInterceptorTTNet, C12470a aVar) throws Exception {
        if (!(aVar.mo30458b() instanceof C15459b)) {
            return ApiCheckInterceptorTTNet.m109715b(aVar);
        }
        ...
        bVar.mo39011a(apiCheckInterceptorTTNet.getClass().getSimpleName());
        bVar.f39780t = SystemClock.uptimeMillis();
        C12534t b = ApiCheckInterceptorTTNet.m109715b(aVar);
        if (bVar.f39781u > 0) {
