...
final class C34080j {
    /* renamed from: a */
    static C12534t m109747a(FeedRetryInterceptorTTNet feedRetryInterceptorTTNet, C12470a aVar) throws Exception {
        if (!(aVar.mo30458b() instanceof C15459b)) {
            return feedRetryInterceptorTTNet.mo86746b(aVar);
        }
        ...
        bVar.mo39011a(feedRetryInterceptorTTNet.getClass().getSimpleName());
        bVar.f39780t = SystemClock.uptimeMillis();
        C12534t b = feedRetryInterceptorTTNet.mo86746b(aVar);
        if (bVar.f39781u > 0) {
            long uptimeMillis2 = SystemClock.uptimeMillis() - bVar.f39781u;
            String simpleName = feedRetryInterceptorTTNet.getClass().getSimpleName();
