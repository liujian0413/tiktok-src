...
/* renamed from: com.ss.android.ugc.aweme.app.api.UserTypeAdapterFactory */
public class UserTypeAdapterFactory implements C6717s {
    public <T> C6715r<T> create(C6600e eVar, C6597a<T> aVar) {
        ...
        return new C6715r<T>() {
            public final T read(C6718a aVar) throws IOException {
                ...
                T t = (User) a.read(aVar);
                C43077dz.m136657a().mo104731a(t.getUid(), t.getSecUid());
                return t;
            }
