...
/* renamed from: com.ss.android.ugc.aweme.newfollow.vh.InsForwardImageViewHolderPlanA */
public class InsForwardImageViewHolderPlanA extends InsForwardImageViewHolder {
    ...
    public void mo76020a(View view, int i, int i2) {
        ...
        if (layoutParams != null) {
            ...
            mo87012a(a, b, b2, ((float) i2) / ((float) i), iArr);
    ...
    public InsForwardImageViewHolderPlanA(FollowFeedLayout followFeedLayout, C21744b bVar, C29376j jVar, C21747e eVar, C21743a aVar) {
    ...
    /* renamed from: a */
    public void mo87012a(int i, int i2, float f, float f2, int[] iArr) {
