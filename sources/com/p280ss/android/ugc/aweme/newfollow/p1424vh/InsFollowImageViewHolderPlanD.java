...
/* renamed from: com.ss.android.ugc.aweme.newfollow.vh.InsFollowImageViewHolderPlanD */
public class InsFollowImageViewHolderPlanD extends InsFollowImageViewHolderPlanA {
    /* renamed from: a */
    private final void m110619a(int i, float f, int[] iArr) {
        if (f > 1.2533333f) {
    ...
    public final void mo68503a(View view, int i, int i2) {
        ...
        if (layoutParams != null) {
            ...
            int[] iArr = new int[2];
            m110619a(C9738o.m28691a(mo75261ab()), ((float) i2) / ((float) i), iArr);
    ...
    public InsFollowImageViewHolderPlanD(FollowFeedLayout followFeedLayout, C21744b bVar, C29376j jVar, C21743a aVar) {
