...
import com.p280ss.android.ugc.aweme.newfollow.adapter.FollowFlowItemImageForwardViewHolder;
...
/* renamed from: com.ss.android.ugc.aweme.newfollow.vh.InsForwardImageViewHolder */
public class InsForwardImageViewHolder extends FollowFlowItemImageForwardViewHolder {

    /* renamed from: Y */
    private final DmtTextView f89331Y;

    /* renamed from: com.ss.android.ugc.aweme.newfollow.vh.InsForwardImageViewHolder$a */
    static final class C34254a implements C43347e {

        /* renamed from: a */
        final /* synthetic */ InsForwardImageViewHolder f89333a;

        C34254a(InsForwardImageViewHolder insForwardImageViewHolder) {
            this.f89333a = insForwardImageViewHolder;
        }

        /* renamed from: a */
        public final void mo62358a(View view, TextExtraStruct textExtraStruct) {
            if (this.f89333a.f78550D != null) {
                this.f89333a.f78550D.mo58082a(view, textExtraStruct, this.f89333a.itemView, this.f89333a.f78552F);
            }
        }
    }

    /* renamed from: com.ss.android.ugc.aweme.newfollow.vh.InsForwardImageViewHolder$b */
    static final class C34255b implements C43347e {

        /* renamed from: a */
        final /* synthetic */ InsForwardImageViewHolder f89334a;

        C34255b(InsForwardImageViewHolder insForwardImageViewHolder) {
            this.f89334a = insForwardImageViewHolder;
        }

        /* renamed from: a */
        public final void mo62358a(View view, TextExtraStruct textExtraStruct) {
            if (this.f89334a.f78550D != null) {
                this.f89334a.f78550D.mo58082a(view, textExtraStruct, this.f89334a.itemView, this.f89334a.f78552F);
            }
        }
    }
    ...
    public void mo76029c(View view) {
        ...
        viewStub3.setLayoutResource(R.layout.a7v);
    ...
    public final void mo76023a(MentionTextView mentionTextView, Aweme aweme) {
        ...
        if (aweme != null) {
            ...
            if (!TextUtils.isEmpty(aweme.getDesc())) {
                ...
                mentionTextView.setOnSpanClickListener(new C34254a(this));
    ...
    public final void mo76028b(MentionTextView mentionTextView, Aweme aweme) {
        ...
        if (aweme != null) {
            ...
            C27608b.m90502a((TextView) mentionTextView);
            mentionTextView.setSpanSize(C9738o.m28690a(mo75888b(), 15.0f));
            mentionTextView.setOnSpanClickListener(new C34255b(this));
    ...
    public InsForwardImageViewHolder(FollowFeedLayout followFeedLayout, C21744b bVar, C29376j jVar, C21747e eVar, C21743a aVar) {
        ...
        this.f89331Y = (DmtTextView) findViewById;
        this.f89331Y.setOnClickListener(new OnClickListener(this) {

            /* renamed from: a */
            final /* synthetic */ InsForwardImageViewHolder f89332a;
