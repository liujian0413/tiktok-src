...
/* renamed from: com.ss.android.ugc.aweme.newfollow.vh.InsForwardVideoViewHolderPlanD */
public class InsForwardVideoViewHolderPlanD extends InsForwardVideoViewHolderPlanA {
    /* renamed from: a */
    private final void m110772a(int i, float f, int[] iArr) {
        if (f > 1.2533333f) {
    ...
    public final void mo76020a(View view, int i, int i2) {
        ...
        if (layoutParams != null) {
            ...
            int[] iArr = new int[2];
            m110772a(C9738o.m28691a(mo75888b()), ((float) i2) / ((float) i), iArr);
    ...
    public InsForwardVideoViewHolderPlanD(FollowFeedLayout followFeedLayout, C21744b bVar, C29376j jVar, C21747e eVar, C21743a aVar) {
