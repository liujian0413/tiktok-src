...
/* renamed from: com.ss.android.ugc.aweme.newfollow.vh.FixRatioFollowImageViewHolder */
public class FixRatioFollowImageViewHolder extends FollowImageViewHolder {
    ...
    public final void mo68503a(View view, int i, int i2) {
        ...
        int[] iArr = new int[2];
        m110501a(C9738o.m28691a(mo75261ab()), C9738o.m28709b(mo75261ab()), C9738o.m28708b(mo75261ab(), 16.0f), ((float) i2) / ((float) i), iArr);
        layoutParams.width = iArr[0];
        layoutParams.height = iArr[1];
        view.setLayoutParams(layoutParams);
    }

    public FixRatioFollowImageViewHolder(FollowFeedLayout followFeedLayout, C21744b bVar, C29376j jVar, C21743a aVar) {
        super(followFeedLayout, bVar, jVar, aVar, true);
    }

    /* renamed from: a */
    private static void m110501a(int i, int i2, float f, float f2, int[] iArr) {
