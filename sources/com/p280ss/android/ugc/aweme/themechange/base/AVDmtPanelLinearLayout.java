...
public final class AVDmtPanelLinearLayout extends LinearLayout {
    public AVDmtPanelLinearLayout(Context context) {
    ...
    public /* synthetic */ AVDmtPanelLinearLayout(Context context, AttributeSet attributeSet, int i, int i2, C7571f fVar) {
        if ((i2 & 2) != 0) {
            attributeSet = null;
        }
        if ((i2 & 4) != 0) {
