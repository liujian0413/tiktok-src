...
public abstract class BaseCommentJediWidget extends Widget implements C11592h {

    /* renamed from: com.ss.android.ugc.aweme.comment.widgets.BaseCommentJediWidget$a */
    protected static final class C24377a<T extends View> {
        ...
        public C24377a(int i) {
            this.f64344b = i;
        }

        /* renamed from: a */
        public final T mo63301a(BaseCommentJediWidget baseCommentJediWidget, C7595j<?> jVar) {
            C7573i.m23587b(baseCommentJediWidget, "thisRef");
            C7573i.m23587b(jVar, "property");
            if (this.f64343a == null) {
                View view = baseCommentJediWidget.f34459e;
                if (view == null) {
                    C7573i.m23580a();
                }
                T findViewById = view.findViewById(this.f64344b);
                if (findViewById == null) {
                    C7573i.m23580a();
                }
                this.f64343a = findViewById;
            }
            T t = this.f64343a;
            if (t == null) {
    ...
    /* renamed from: a */
    protected static <T extends View> C24377a<T> m80103a(int i) {
        return new C24377a<>(i);
    }

    /* renamed from: a */
    protected static void m80104a(View... viewArr) {
