...
/* renamed from: com.ss.android.medialib.d.c */
public final class C19716c {

    /* renamed from: a */
    private static String f53480a;

    /* renamed from: c */
    public static int m65010c() {
        try {
    ...
    /* renamed from: a */
    public static String m65006a() {
        BufferedReader bufferedReader;
        Reader reader;
        Throwable th;
        if (!TextUtils.isEmpty(f53480a)) {
            return f53480a;
        }
        try {
    ...
    public static java.lang.String m65009b() {
        /*
            java.lang.String r0 = ""
            r1 = 2
            r2 = 0
        ...
        L_0x0053:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p280ss.android.medialib.p883d.C19716c.m65009b():java.lang.String");
    }
    ...
    public static long m65012d() {
        ...
        L_0x0051:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p280ss.android.medialib.p883d.C19716c.m65012d():long");
    }

    /* renamed from: a */
    private static void m65007a(Reader reader) {
        if (reader != null) {
            try {
                reader.close();
            } catch (IOException unused) {
    ...
    /* renamed from: b */
    public static int m65008b(Context context) {
        if (context == null) {
            return 0;
        }
    ...
    /* renamed from: d */
    public static String m65013d(Context context) {
        try {
            return ((TelephonyManager) context.getSystemService("phone")).getSimOperator();
        } catch (Exception unused) {
            C45372t.m143407c("DeviceInfoUtils", "No permission");
            return "";
        }
    }

    /* renamed from: a */
    public static long m65005a(Context context) {
        String str;
        try {
    ...
    /* renamed from: c */
    public static int m65011c(Context context) {
        int i = 0;
        if (context == null) {
            return 0;
        }
