...
public final class C20592e extends C20590c {

    /* renamed from: c */
    public static final Map<String, String> f55633c = new HashMap<String, String>() {
        {
    ...
    /* renamed from: b */
    public static boolean m68190b(Context context, int i) {
        try {
            C18616b a = C18616b.m61064a();
            String str = ((CameraManager) context.getSystemService("camera")).getCameraIdList()[i];
            String b = a.mo48807b((String) f55633c.get(context.getPackageName()));
            if (b != null && !b.isEmpty()) {
            ...
            C20652m.m68436c("TECameraOppoProxy", "AntiShake verify cause this exception");
        }
        return false;
    }
}
