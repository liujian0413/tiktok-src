...
public final class Frame extends Message<Frame, Builder> implements Parcelable, C45439a {
    ...
    public static final Creator<Frame> CREATOR = new Creator<Frame>() {
        /* renamed from: a */
        private static Frame[] m143652a(int i) {
            return new Frame[i];
        }

        public final /* synthetic */ Object createFromParcel(Parcel parcel) {
            return m143651a(parcel);
        }
        ...
        /* renamed from: a */
        private static Frame m143651a(Parcel parcel) {
            try {
                return (Frame) Frame.ADAPTER.decode(parcel.createByteArray());
            } catch (IOException e) {
    ...
    @WireField(adapter = "com.ss.android.websocket.internal.proto.Frame$ExtendedEntry#ADAPTER", label = Label.REPEATED, tag = 5)
