...
public final class GuideWordV2 extends Message<GuideWordV2, Builder> {
    ...
    public static final class Builder extends com.squareup.wire.Message.Builder<GuideWordV2, Builder> {
        public Integer breathe_times;
        public String search_word;
        public Integer type;
        public String word;
        ...
        public final GuideWordV2 build() {
            GuideWordV2 guideWordV2 = new GuideWordV2(this.word, this.search_word, this.type, this.breathe_times, super.buildUnknownFields());
            return guideWordV2;
        }
                ...
                if (nextTag != -1) {
                    switch (nextTag) {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            builder.breathe_times((Integer) ProtoAdapter.INT32.decode(protoReader));
                            break;
                        default:
    ...
    public final int hashCode() {
        ...
        if (this.breathe_times != null) {
            i5 = this.breathe_times.hashCode();
        }
        int i9 = i8 + i5;
        this.hashCode = i9;
        return i9;
    ...
    public final String toString() {
        ...
        if (this.breathe_times != null) {
            sb.append(", breathe_times=");
            sb.append(this.breathe_times);
        }
    ...
    public GuideWordV2(String str, String str2, Integer num, Integer num2, ByteString byteString) {
