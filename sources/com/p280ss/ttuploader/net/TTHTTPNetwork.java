        ...
        this.mCall.enqueue(new Callback() {
            ...
            public void onResponse(okhttp3.Call r5, okhttp3.Response r6) {
                ...
                L_0x0029:
                    ...
                    com.ss.ttuploader.net.TTVNetClient$CompletionListener r6 = r8
                    r6.onCompletion(r2, r5)
                    return
                L_0x0031:
                    com.ss.ttuploader.net.TTVNetClient$CompletionListener r6 = r8
                    com.ss.ttuploader.net.Error r0 = new com.ss.ttuploader.net.Error
                    r3 = 0
                ...
                L_0x0049:
                    throw r5
                */
                throw new UnsupportedOperationException("Method not decompiled: com.p280ss.ttuploader.net.TTHTTPNetwork.C460081.onResponse(okhttp3.Call, okhttp3.Response):void");
            }
        });
    }
        ...
        this.mCall.enqueue(new Callback() {
            ...
            public void onResponse(okhttp3.Call r5, okhttp3.Response r6) throws java.io.IOException {
                ...
                L_0x0025:
                    ...
                    com.ss.ttuploader.net.TTVNetClient$CompletionListener r6 = r10
                    r6.onCompletion(r2, r5)
                    return
                L_0x002d:
                    com.ss.ttuploader.net.TTVNetClient$CompletionListener r6 = r10
                ...
                L_0x0045:
                    throw r5
                */
                throw new UnsupportedOperationException("Method not decompiled: com.p280ss.ttuploader.net.TTHTTPNetwork.C460092.onResponse(okhttp3.Call, okhttp3.Response):void");
            }
        });
    }
}
