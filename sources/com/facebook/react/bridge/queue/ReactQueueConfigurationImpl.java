...
public class ReactQueueConfigurationImpl implements ReactQueueConfiguration {
    ...
    public static ReactQueueConfigurationImpl create(ReactQueueConfigurationSpec reactQueueConfigurationSpec, QueueThreadExceptionHandler queueThreadExceptionHandler) {
        ...
        MessageQueueThreadImpl messageQueueThreadImpl3 = (MessageQueueThreadImpl) newHashMap.get(reactQueueConfigurationSpec.getLayoutThreadSpec());
        if (messageQueueThreadImpl3 == null) {
            messageQueueThreadImpl3 = MessageQueueThreadImpl.create(reactQueueConfigurationSpec.getLayoutThreadSpec(), queueThreadExceptionHandler);
        }
        return new ReactQueueConfigurationImpl(create, messageQueueThreadImpl2, messageQueueThreadImpl, messageQueueThreadImpl3);
    }
    ...
    private ReactQueueConfigurationImpl(MessageQueueThreadImpl messageQueueThreadImpl, MessageQueueThreadImpl messageQueueThreadImpl2, MessageQueueThreadImpl messageQueueThreadImpl3, MessageQueueThreadImpl messageQueueThreadImpl4) {
        ...
        this.mLayoutThread = messageQueueThreadImpl4;
    }
}
