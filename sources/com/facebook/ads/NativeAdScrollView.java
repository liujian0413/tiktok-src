...
public class NativeAdScrollView extends LinearLayout {
    ...
    private NativeAdScrollView(Context context, NativeAdsManager nativeAdsManager, AdViewProvider adViewProvider, int i, Type type, NativeAdViewAttributes nativeAdViewAttributes, int i2) {
        super(context);
