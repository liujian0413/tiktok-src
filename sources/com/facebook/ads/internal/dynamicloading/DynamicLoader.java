...
public interface DynamicLoader {
    ...
    AdOptionsViewApi createAdOptionsView(Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, Orientation orientation, int i, AdOptionsView adOptionsView);
    ...
    AdsMessengerServiceApi createAdsMessengerServiceApi(AdsMessengerService adsMessengerService);
    ...
    NativeAdScrollViewApi createNativeAdScrollViewApi(NativeAdScrollView nativeAdScrollView, Context context, NativeAdsManager nativeAdsManager, AdViewProvider adViewProvider, int i, Type type, NativeAdViewAttributes nativeAdViewAttributes, int i2);
