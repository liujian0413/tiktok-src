...
public final class C10186f {
    ...
    /* renamed from: d */
    private static String m30258d(Context context) {
        return C10187g.m30259a(context);
    }
    ...
    private static java.lang.String m30254a() {
        /*
            r0 = 0
        ...
        L_0x0053:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.frameworks.baselib.network.http.util.C10186f.m30254a():java.lang.String");
    }

    /* renamed from: a */
    public static boolean m30255a(Context context) {
        String d = m30258d(context);
        if (d == null || (!d.endsWith(":push") && !d.endsWith(":pushservice"))) {
            return false;
        }
        return true;
    }
    ...
    /* renamed from: b */
    public static boolean m30256b(Context context) {
        String d = m30258d(context);
        if ((d == null || !d.contains(":")) && d != null && d.equals(context.getPackageName())) {
            return true;
        }
        return false;
    }
    ...
    /* renamed from: c */
    public static String m30257c(Context context) {
        String str = f27722a;
