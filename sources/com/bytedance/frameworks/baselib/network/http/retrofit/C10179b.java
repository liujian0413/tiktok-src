...
final class C10179b {
    /* renamed from: a */
    static C12534t m30245a(RequestVertifyInterceptor requestVertifyInterceptor, C12470a aVar) throws Exception {
        if (!(aVar.mo30458b() instanceof C15459b)) {
            return requestVertifyInterceptor.mo24874b(aVar);
        }
        ...
        bVar.mo39011a(requestVertifyInterceptor.getClass().getSimpleName());
        bVar.f39780t = SystemClock.uptimeMillis();
        C12534t b = requestVertifyInterceptor.mo24874b(aVar);
        if (bVar.f39781u > 0) {
            long uptimeMillis2 = SystemClock.uptimeMillis() - bVar.f39781u;
            String simpleName = requestVertifyInterceptor.getClass().getSimpleName();
