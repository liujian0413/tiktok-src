...
final class C10026g {
    /* renamed from: a */
    static InputStream m29793a(HttpURLConnection httpURLConnection) throws IOException {
    ...
    /* renamed from: a */
    static void m29794a(HttpURLConnection httpURLConnection, String str, String str2) {
        URLConnection uRLConnection = httpURLConnection;
        if (C7118e.m22232a(uRLConnection)) {
