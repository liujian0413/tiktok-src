...
public final class C4352g extends C4343b<C8538c> {
    /* renamed from: e */
    ...
    public final Spannable mo12070m() {
        return C4372y.m14743a(this.f12647a.baseMessage.f25996f, (int) R.color.aei);
    }

    /* access modifiers changed from: protected */
    /* renamed from: l */
    public final Spannable mo12069l() {
        String str = this.f12647a.baseMessage.f25996f;
        C9178j.m27302j().mo22379h();
        return C4372y.m14743a(str, (int) R.color.alu);
    }

    public C4352g(C8538c cVar) {
        super(cVar);
    }
}
