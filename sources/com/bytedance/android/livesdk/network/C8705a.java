...
/* renamed from: com.bytedance.android.livesdk.network.a */
final class C8705a {
    /* renamed from: a */
    static C12534t m26020a(TTHostReplaceInterceptor tTHostReplaceInterceptor, C12470a aVar) throws Exception {
        if (!(aVar.mo30458b() instanceof C15459b)) {
            return TTHostReplaceInterceptor.m26018b(aVar);
        }
        ...
        bVar.mo39011a(tTHostReplaceInterceptor.getClass().getSimpleName());
        bVar.f39780t = SystemClock.uptimeMillis();
        C12534t b = TTHostReplaceInterceptor.m26018b(aVar);
        if (bVar.f39781u > 0) {
            long uptimeMillis2 = SystemClock.uptimeMillis() - bVar.f39781u;
            String simpleName = tTHostReplaceInterceptor.getClass().getSimpleName();
