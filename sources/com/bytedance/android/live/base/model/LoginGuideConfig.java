...
public class LoginGuideConfig {
    @C6593c(mo15949a = "from_comment")
    private String fromComment;
    @C6593c(mo15949a = "from_default")
    private String fromDefault;
    @C6593c(mo15949a = "from_favorite")
    private String fromFavorite;
    @C6593c(mo15949a = "from_follow")
    private String fromFollow;
    @C6593c(mo15949a = "from_home_upper_right")
    private String fromHomeUpperRight;
    @C6593c(mo15949a = "image_url_from_comment")
    private String imageUrlFromComment;
    @C6593c(mo15949a = "image_url_from_default")
    private String imageUrlFromDefault;
    @C6593c(mo15949a = "image_url_from_favorite")
    private String imageUrlFromFavorite;
    @C6593c(mo15949a = "image_url_from_follow")
    private String imageUrlFromFollow;
    @C6593c(mo15949a = "image_url_from_home_upper_right")
