...
/* renamed from: com.bytedance.framwork.core.monitor.b */
final class C6378b {
    /* renamed from: a */
    static InputStream m19820a(HttpURLConnection httpURLConnection) throws IOException {
    ...
    /* renamed from: a */
    static void m19821a(HttpURLConnection httpURLConnection, String str, String str2) {
        URLConnection uRLConnection = httpURLConnection;
        if (C7118e.m22232a(uRLConnection)) {
