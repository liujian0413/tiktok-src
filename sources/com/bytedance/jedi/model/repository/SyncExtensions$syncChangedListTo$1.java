...
public final class SyncExtensions$syncChangedListTo$1 extends Lambda implements C7562b<C11802a<? extends Object, List<? extends V>, K1, V1>, C7581n> {
    final /* synthetic */ C7562b $map;

    public SyncExtensions$syncChangedListTo$1(C7562b bVar) {
        this.$map = bVar;
        super(1);
    }
    ...
    public final void invoke(C11802a<? extends Object, List<V>, K1, V1> aVar) {
        ...
        aVar.mo29358a(new C7562b<List<? extends V>, List<? extends Pair<? extends K1, ? extends V1>>>(this) {
            final /* synthetic */ SyncExtensions$syncChangedListTo$1 this$0;
