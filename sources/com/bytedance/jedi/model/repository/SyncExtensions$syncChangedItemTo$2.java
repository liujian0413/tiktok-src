...
public final class SyncExtensions$syncChangedItemTo$2 extends Lambda implements C7562b<C11811d<K, V, K1, List<? extends V1>>, C7581n> {
    final /* synthetic */ C7563m $needUpdate;
    final /* synthetic */ C7563m $update;

    public SyncExtensions$syncChangedItemTo$2(C7563m mVar, C7563m mVar2) {
    ...
    public final void invoke(C11811d<K, V, K1, List<V1>> dVar) {
        ...
        dVar.mo29361a(C119771.INSTANCE);
        dVar.mo29362b(new C7563m<V, List<? extends V1>, List<? extends V1>>(this) {
            final /* synthetic */ SyncExtensions$syncChangedItemTo$2 this$0;
