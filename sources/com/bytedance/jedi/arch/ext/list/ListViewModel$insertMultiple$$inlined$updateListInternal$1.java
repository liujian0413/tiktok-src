...
public final class ListViewModel$insertMultiple$$inlined$updateListInternal$1 extends Lambda implements C7562b<S, S> {
    final /* synthetic */ List $data$inlined;
    final /* synthetic */ int $position$inlined;
    final /* synthetic */ ListViewModel this$0;

    public ListViewModel$insertMultiple$$inlined$updateListInternal$1(ListViewModel listViewModel, int i, List list) {
    ...
    public final S invoke(S s) {
        ...
        if (!C48020o.f122844a || z) {
            ...
            d.addAll(this.$position$inlined, this.$data$inlined);
