...
public final class ListViewModel$modify$$inlined$updateListInternal$1 extends Lambda implements C7562b<S, S> {
    final /* synthetic */ Object $data$inlined;
    final /* synthetic */ int $position$inlined;
    final /* synthetic */ ListViewModel this$0;

    public ListViewModel$modify$$inlined$updateListInternal$1(ListViewModel listViewModel, int i, Object obj) {
    ...
    public final S invoke(S s) {
        ...
        if (!C48020o.f122844a || z) {
            ...
            d.set(this.$position$inlined, this.$data$inlined);
