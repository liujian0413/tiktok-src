...
/* renamed from: com.bytedance.ies.bullet.kit.rn.pkg.viewshot.RNViewShotModule */
public class RNViewShotModule extends ReactContextBaseJavaModule {
    private final ReactApplicationContext reactContext;

    /* renamed from: com.bytedance.ies.bullet.kit.rn.pkg.viewshot.RNViewShotModule$a */
    static class C10608a extends GuardedAsyncTask<Void, Void> implements FilenameFilter {
        ...
        private C10608a(ReactContext reactContext) {
            super(reactContext);
            this.f28434a = reactContext.getCacheDir();
            this.f28435b = reactContext.getExternalCacheDir();
        }

        /* renamed from: a */
        private void m31024a(File file) {
        ...
        public void doInBackgroundGuarded(Void... voidArr) {
            if (this.f28434a != null) {
                m31024a(this.f28434a);
            }
            if (this.f28435b != null) {
                m31024a(this.f28435b);
            }
        }
    ...
    public void onCatalystInstanceDestroy() {
        ...
        new C10608a(getReactApplicationContext()).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new Void[0]);
    }
    ...
    public void captureRef(int i, ReadableMap readableMap, Promise promise) {
        ...
        try {
            ...
            int i3 = i;
            C10611c cVar = new C10611c(i3, string, i2, d, num, num2, file, string2, valueOf, this.reactContext, getCurrentActivity(), promise);
