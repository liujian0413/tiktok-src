...
import com.bytedance.p263im.core.proto.GetConversationParticipantsMinIndexV3RequestBody;
...
/* renamed from: com.bytedance.im.core.internal.a.a.j */
public final class C11271j extends C11280o<List<ParticipantMinIndex>> {
    public C11271j() {
        super(IMCMD.GET_CONVERSATION_PARTICIPANTS_MIN_INDEX_V3.getValue());
    }

    public C11271j(C11195b<List<ParticipantMinIndex>> bVar) {
    ...
    public final boolean mo27265a(C11391e eVar) {
        if (eVar == null || eVar.f30858g == null || eVar.f30858g.body == null || eVar.f30858g.body.participants_min_index_body == null) {
            return false;
        }
        return true;
    }
    ...
    /* renamed from: a */
    public final void mo27296a(String str) {
    ...
    public final void mo27263a(C11391e eVar, Runnable runnable) {
        ...
        if (z) {
            mo27302a(eVar.f30858g.body.participants_min_index_body.indexes);
            C11404d.m33582a(C1642a.m8034a("request minIndex result=%s", new Object[]{C11403c.f30887a.mo15979b((Object) eVar.f30858g.body.participants_min_index_body.indexes)}));
        } else {
            mo27305b(eVar);
            C11404d.m33582a("request minIndex error");
        }
