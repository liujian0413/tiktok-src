...
public final class GetConversationInfoRequestBody extends Message<GetConversationInfoRequestBody, Builder> {
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof GetConversationInfoRequestBody)) {
            return false;
        }
        GetConversationInfoRequestBody getConversationInfoRequestBody = (GetConversationInfoRequestBody) obj;
        if (!unknownFields().equals(getConversationInfoRequestBody.unknownFields()) || !Internal.equals(this.conversation_id, getConversationInfoRequestBody.conversation_id) || !Internal.equals(this.conversation_short_id, getConversationInfoRequestBody.conversation_short_id) || !Internal.equals(this.conversation_type, getConversationInfoRequestBody.conversation_type)) {
            return false;
        }
        return true;
    }
