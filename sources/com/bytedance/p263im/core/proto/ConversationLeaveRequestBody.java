...
public final class ConversationLeaveRequestBody extends Message<ConversationLeaveRequestBody, Builder> {
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof ConversationLeaveRequestBody)) {
            return false;
        }
        ConversationLeaveRequestBody conversationLeaveRequestBody = (ConversationLeaveRequestBody) obj;
        if (!unknownFields().equals(conversationLeaveRequestBody.unknownFields()) || !Internal.equals(this.conversation_id, conversationLeaveRequestBody.conversation_id) || !Internal.equals(this.conversation_short_id, conversationLeaveRequestBody.conversation_short_id) || !Internal.equals(this.conversation_type, conversationLeaveRequestBody.conversation_type)) {
            return false;
        }
        return true;
    }
