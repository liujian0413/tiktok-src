...
public final class MessagesPerUserResponseBody extends Message<MessagesPerUserResponseBody, Builder> {
    ...
    public final boolean equals(Object obj) {
        ...
        if (!unknownFields().equals(messagesPerUserResponseBody.unknownFields()) || !this.messages.equals(messagesPerUserResponseBody.messages) || !Internal.equals(this.next_cursor, messagesPerUserResponseBody.next_cursor) || !Internal.equals(this.has_more, messagesPerUserResponseBody.has_more)) {
            return false;
        }
        return true;
    }
