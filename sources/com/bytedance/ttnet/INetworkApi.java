...
public interface INetworkApi {
    ...
    @C6468s
    C12466b<String> postBody(@C6463n int i, @C6450ac String str, @C6475z(mo15759a = true) Map<String, String> map, @C6451b TypedOutput typedOutput, @C6461l List<C12461b> list);

    @C6465p
    @C6468s
    C12466b<String> postMultiPart(@C6463n int i, @C6450ac String str, @C6475z(mo15759a = true) Map<String, String> map, @C6471v Map<String, TypedOutput> map2, @C6461l List<C12461b> list);
}
