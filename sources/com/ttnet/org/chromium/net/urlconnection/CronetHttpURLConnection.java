...
public class CronetHttpURLConnection extends HttpURLConnection {
    ...
    class CronetUrlRequestCallback extends Callback {
        private void setRequestEnd() {
            ...
            try {
                ...
                if (Logger.debug()) {
                    ...
                    Logger.m146406d(str, sb.toString());
                }
            }
            try {
                if (CronetHttpURLConnection.this.mException != null) {
                    ...
                    if (!TextUtils.isEmpty(str2)) {
                        ...
                        sb3.append(message);
                        Reflect.m146422on((Object) CronetHttpURLConnection.this.mException).set("detailMessage", sb3.toString());
                    }
                }
        ...
        public void onRedirectReceived(UrlRequest urlRequest, UrlResponseInfo urlResponseInfo, String str) {
            ...
            if (Logger.debug()) {
                ...
                sb.append(CronetHttpURLConnection.this.getURL().toString());
                Logger.m146406d(str2, sb.toString());
            }
        }
    }
        ...
        if (this.mOutputStream == null && this.doOutput) {
            if (this.connected) {
                ...
                if (streamingModeContentLength != -1) {
                    ...
                    Log.m146386d(TAG, "Outputstream is being buffered in memory.");
    ...
    private void startRequest() throws IOException {
        if (!this.connected) {
            ...
            Builder builder = (Builder) this.mCronetEngine.newUrlRequestBuilder(getURL().toString(), new CronetUrlRequestCallback(), this.mMessageLoop);
            if (this.doOutput) {
                if (this.method.equals("GET")) {
                    this.method = "POST";
                }
                if (this.mOutputStream != null) {
                    builder.setUploadDataProvider(this.mOutputStream.getUploadDataProvider(), (Executor) this.mMessageLoop);
            ...
            try {
                ...
                if (Logger.debug()) {
                    ...
                    Logger.m146406d(str4, sb2.toString());
                }
            }
            if (map != null && map.size() > 0) {
                for (Entry entry : map.entrySet()) {
                    ...
                    if (("X-SS-Cookie".equalsIgnoreCase(str5) || "Cookie".equalsIgnoreCase(str5) || "Cookie2".equalsIgnoreCase(str5)) && !((List) entry.getValue()).isEmpty()) {
                        ...
                        builder.addHeader(str5, sb3.toString());
                    }
                }
            }
    ...
    public java.io.IOException tryConvertCronetException(com.ttnet.org.chromium.net.CronetException r4) {
        /*
            r3 = this;
            boolean r0 = r4 instanceof com.ttnet.org.chromium.net.NetworkException
        ...
        L_0x0064:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ttnet.org.chromium.net.urlconnection.CronetHttpURLConnection.tryConvertCronetException(com.ttnet.org.chromium.net.CronetException):java.io.IOException");
    }
