...
public class ProcessUtils {
    ...
    private static java.lang.String getCurProcessNameFromProc() {
        ...
        L_0x002e:
            ...
            goto L_0x002e
        L_0x0039:
            boolean r3 = com.ttnet.org.chromium.base1.Logger.debug()     // Catch:{ Throwable -> 0x006b, all -> 0x005e }
            ...
            com.ttnet.org.chromium.base1.Logger.m146431d(r3, r4)     // Catch:{ Throwable -> 0x006b, all -> 0x005e }
        L_0x0056:
        ...
        L_0x0070:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ttnet.org.chromium.base1.ProcessUtils.getCurProcessNameFromProc():java.lang.String");
    }
            ...
            for (RunningAppProcessInfo runningAppProcessInfo : ((ActivityManager) context.getSystemService("activity")).getRunningAppProcesses()) {
                if (runningAppProcessInfo.pid == myPid) {
                    if (Logger.debug()) {
                        ...
                        Logger.m146431d("Process", sb.toString());
                    }
