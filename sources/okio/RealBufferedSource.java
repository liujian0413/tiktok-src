...
final class RealBufferedSource implements BufferedSource {
    ...
    public final long readDecimalLong() throws java.io.IOException {
        ...
        L_0x002b:
            ...
            java.lang.String r0 = com.C1642a.m8034a(r0, r2)
            r1.<init>(r0)
            throw r1
        L_0x0040:
    ...
    public final long readHexadecimalUnsignedLong() throws IOException {
        ...
        while (true) {
            ...
            if ((b >= 48 && b <= 57) || ((b >= 97 && b <= 102) || (b >= 65 && b <= 70))) {
                ...
                throw new NumberFormatException(C1642a.m8034a("Expected leading [0-9a-fA-F] character but was %#x", new Object[]{Byte.valueOf(b)}));
            }
        }
    ...
    public final long indexOf(byte b, long j, long j2) throws IOException {
        if (this.closed) {
            ...
            throw new IllegalArgumentException(C1642a.m8034a("fromIndex=%s toIndex=%s", new Object[]{Long.valueOf(j), Long.valueOf(j2)}));
        } else {
            while (j < j2) {
