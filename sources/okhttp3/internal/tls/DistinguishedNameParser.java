...
final class DistinguishedNameParser {
    ...
    /* renamed from: dn */
    private final String f123348dn;
    private int end;
    private final int length = this.f123348dn.length();
    private int pos;
    ...
    DistinguishedNameParser(X500Principal x500Principal) {
        this.f123348dn = x500Principal.getName("RFC2253");
    }
    ...
    public final String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f123348dn.toCharArray();
