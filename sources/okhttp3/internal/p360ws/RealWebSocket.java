...
import okhttp3.internal.p360ws.WebSocketReader.FrameCallback;
...
public final class RealWebSocket implements WebSocket, FrameCallback {
    ...
    public final void writePingFrame() {
        ...
        L_0x0050:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p360ws.RealWebSocket.writePingFrame():void");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x0059, code lost:
        if ((r4 instanceof okhttp3.internal.p360ws.RealWebSocket.Message) == false) goto L_0x0087;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:27:0x005b, code lost:
        r1 = ((okhttp3.internal.p360ws.RealWebSocket.Message) r4).data;
        r0 = okio.Okio.buffer(r0.newMessageSink(((okhttp3.internal.p360ws.RealWebSocket.Message) r4).formatOpcode, (long) r1.size()));
        r0.write(r1);
        r0.close();
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:38:0x0089, code lost:
        if ((r4 instanceof okhttp3.internal.p360ws.RealWebSocket.Close) == false) goto L_0x00a0;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:39:0x008b, code lost:
        r4 = (okhttp3.internal.p360ws.RealWebSocket.Close) r4;
    ...
    public final boolean writeOneFrame() throws java.io.IOException {
        ...
        L_0x0008:
            ...
            boolean r5 = r4 instanceof okhttp3.internal.p360ws.RealWebSocket.Close     // Catch:{ all -> 0x00aa }
        ...
        L_0x0031:
            ...
            r8 = r4
            okhttp3.internal.ws.RealWebSocket$Close r8 = (okhttp3.internal.p360ws.RealWebSocket.Close) r8     // Catch:{ all -> 0x00aa }
        ...
        L_0x0055:
            ...
            goto L_0x00a6
        L_0x0057:
            boolean r2 = r4 instanceof okhttp3.internal.p360ws.RealWebSocket.Message     // Catch:{ all -> 0x0055 }
            if (r2 == 0) goto L_0x0087
            r1 = r4
            okhttp3.internal.ws.RealWebSocket$Message r1 = (okhttp3.internal.p360ws.RealWebSocket.Message) r1     // Catch:{ all -> 0x0055 }
            okio.ByteString r1 = r1.data     // Catch:{ all -> 0x0055 }
            okhttp3.internal.ws.RealWebSocket$Message r4 = (okhttp3.internal.p360ws.RealWebSocket.Message) r4     // Catch:{ all -> 0x0055 }
        ...
        L_0x0087:
            boolean r2 = r4 instanceof okhttp3.internal.p360ws.RealWebSocket.Close     // Catch:{ all -> 0x0055 }
            if (r2 == 0) goto L_0x00a0
            okhttp3.internal.ws.RealWebSocket$Close r4 = (okhttp3.internal.p360ws.RealWebSocket.Close) r4     // Catch:{ all -> 0x0055 }
        ...
        L_0x00aa:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p360ws.RealWebSocket.writeOneFrame():boolean");
    }
    ...
    public final synchronized void onReadPing(okio.ByteString r2) {
        ...
        L_0x0024:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p360ws.RealWebSocket.onReadPing(okio.ByteString):void");
    }
    ...
    public final void failWebSocket(java.lang.Exception r4, okhttp3.Response r5) {
        ...
        L_0x0031:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p360ws.RealWebSocket.failWebSocket(java.lang.Exception, okhttp3.Response):void");
    }
    ...
    private synchronized boolean send(okio.ByteString r7, int r8) {
        ...
        L_0x003e:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p360ws.RealWebSocket.send(okio.ByteString, int):boolean");
    }
    ...
    public RealWebSocket(Request request, WebSocketListener webSocketListener, Random random2, long j) {
        if ("GET".equals(request.method)) {
            ...
            this.key = ByteString.m23795of(bArr).base64();
