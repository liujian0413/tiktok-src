...
class Huffman {
    ...
    public byte[] decode(byte[] bArr) {
        ...
        for (byte b2 : bArr) {
            ...
            i += 8;
            while (i >= 8) {
                node = node.children[(b >>> (i - 8)) & NormalGiftView.ALPHA_255];
        ...
        while (i > 0) {
            Node node2 = node.children[(b << (8 - i)) & NormalGiftView.ALPHA_255];
    ...
    private void addCode(int i, int i2, byte b) {
        ...
        while (b > 8) {
            b = (byte) (b - 8);
            int i3 = (i2 >>> b) & NormalGiftView.ALPHA_255;
        ...
        int i4 = 8 - b;
        int i5 = (i2 << i4) & NormalGiftView.ALPHA_255;
        int i6 = 1 << i4;
