...
final class Hpack {
    ...
    static final class Writer {
        ...
        public final void writeByteString(ByteString byteString) throws IOException {
            ...
            writeInt(readByteString.size(), 127, PhotoMovieContext.PHOTO_MOVIE_COVER_WIDTH);
        ...
        public final void writeHeaders(List<Header> list) throws IOException {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if (i2 != -1) {
                    writeInt(i2, 127, PhotoMovieContext.PHOTO_MOVIE_COVER_WIDTH);
                } else if (i == -1) {
